...
// x/listing
export const TYPE_URL_MSG_CREATE_MARKET_PERMISSIONLESS = '/protocol.listing.MsgCreateMarketPermissionless';
// x/perpetuals
export const TYPE_URL_MSG_CREATE_PERPETUAL = '/protocol.perpetuals.MsgCreatePerpetual';
// x/prices
export const TYPE_URL_MSG_CREATE_ORACLE_MARKET = '/protocol.prices.MsgCreateOracleMarket';
// x/sending
export const TYPE_URL_MSG_CREATE_TRANSFER = '/protocol.sending.MsgCreateTransfer';
export const TYPE_URL_MSG_WITHDRAW_FROM_SUBACCOUNT = '/protocol.sending.MsgWithdrawFromSubaccount';
export const TYPE_URL_MSG_DEPOSIT_TO_SUBACCOUNT = '/protocol.sending.MsgDepositToSubaccount';
// x/affiliates
export const TYPE_URL_MSG_REGISTER_AFFILIATE = '/protocol.affiliates.MsgRegisterAffiliate';
// x/vault
export const TYPE_URL_MSG_DEPOSIT_TO_MEGAVAULT = '/protocol.vault.MsgDepositToMegavault';
export const TYPE_URL_MSG_WITHDRAW_FROM_MEGAVAULT = '/protocol.vault.MsgWithdrawFromMegavault';
// x/staking
