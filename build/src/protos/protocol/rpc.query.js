...
export const createRPCQueryClient = async ({ rpcEndpoint, }) => {
    ...
    return {
        cosmos: {
            ...
            orm: {
                query: {
                    v1alpha1: (await import('../cosmos/orm/query/v1alpha1/query.rpc.Query.js')).createRpcQueryExtension(client),
                },
            },
            params: {
        ...
        dydxprotocol: {
            accountplus: (await import('./accountplus/query.rpc.Query.js')).createRpcQueryExtension(client),
            affiliates: (await import('./affiliates/query.rpc.Query.js')).createRpcQueryExtension(client),
            assets: (await import('./assets/query.rpc.Query.js')).createRpcQueryExtension(client),
            blocktime: (await import('./blocktime/query.rpc.Query.js')).createRpcQueryExtension(client),
            bridge: (await import('./bridge/query.rpc.Query.js')).createRpcQueryExtension(client),
            clob: (await import('./clob/query.rpc.Query.js')).createRpcQueryExtension(client),
            delaymsg: (await import('./delaymsg/query.rpc.Query.js')).createRpcQueryExtension(client),
            epochs: (await import('./epochs/query.rpc.Query.js')).createRpcQueryExtension(client),
            feetiers: (await import('./feetiers/query.rpc.Query.js')).createRpcQueryExtension(client),
            // govplus: (
            //   await import('./govplus/query.rpc.Query.js')
            // ).createRpcQueryExtension(client),
            listing: (await import('./listing/query.rpc.Query.js')).createRpcQueryExtension(client),
            perpetuals: (await import('./perpetuals/query.rpc.Query.js')).createRpcQueryExtension(client),
            prices: (await import('./prices/query.rpc.Query.js')).createRpcQueryExtension(client),
            ratelimit: (await import('./ratelimit/query.rpc.Query.js')).createRpcQueryExtension(client),
            revshare: (await import('./revshare/query.rpc.Query.js')).createRpcQueryExtension(client),
            rewards: (await import('./rewards/query.rpc.Query.js')).createRpcQueryExtension(client),
            // sending: (
            //   await import('./sending/query.rpc.Query.js')
            // ).createRpcQueryExtension(client),
            stats: (await import('./stats/query.rpc.Query.js')).createRpcQueryExtension(client),
            subaccounts: (await import('./subaccounts/query.rpc.Query.js')).createRpcQueryExtension(client),
            vault: (await import('./vault/query.rpc.Query.js')).createRpcQueryExtension(client),
            vest: (await import('./vest/query.rpc.Query.js')).createRpcQueryExtension(client),
        },
    };
};
