...
export const createLCDClient = async ({ restEndpoint, }) => {
    ...
    return {
        cosmos: {
            ...
            circuit: {
                v1: new (await import('../cosmos/circuit/v1/query.lcd.js')).LCDQueryClient({
                    requestClient,
                }),
            },
            consensus: {
            ...
            nft: {
                v1beta1: new (await import('../cosmos/nft/v1beta1/query.lcd.js')).LCDQueryClient({
                    requestClient,
                }),
            },
            params: {
        ...
        dydxprotocol: {
            accountplus: new (await import('./accountplus/query.lcd.js')).LCDQueryClient({
                requestClient,
            }),
            affiliates: new (await import('./affiliates/query.lcd.js')).LCDQueryClient({
                requestClient,
            }),
            ...
            perpetuals: new (await import('./perpetuals/query.lcd.js')).LCDQueryClient({
                requestClient,
            }),
            ...
            subaccounts: new (await import('./subaccounts/query.lcd.js')).LCDQueryClient({
                requestClient,
            }),
