...
export declare const QueryNextMarketIdRequest: {
    encode(_: QueryNextMarketIdRequest, writer?: _m0.Writer): _m0.Writer;
...
export declare const QueryNextMarketIdResponse: {
    encode(message: QueryNextMarketIdResponse, writer?: _m0.Writer): _m0.Writer;
