...
import { Perpetual, LiquidityTier, PremiumStore, } from './perpetual.js';
...
function createBaseQueryNextPerpetualIdRequest() {
    return {};
}
...
function createBaseQueryNextPerpetualIdResponse() {
    return {
        nextPerpetualId: 0,
    };
}
