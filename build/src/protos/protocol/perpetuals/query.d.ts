...
import { Perpetual, PerpetualSDKType, LiquidityTier, LiquidityTierSDKType, PremiumStore, PremiumStoreSDKType } from './perpetual.js';
...
export declare const QueryNextPerpetualIdRequest: {
    encode(_: QueryNextPerpetualIdRequest, writer?: _m0.Writer): _m0.Writer;
...
export declare const QueryNextPerpetualIdResponse: {
    encode(message: QueryNextPerpetualIdResponse, writer?: _m0.Writer): _m0.Writer;
