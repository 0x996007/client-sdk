export const createRPCMsgClient = async ({ rpc }) => ({
    ...
    dydxprotocol: {
        accountplus: new (await import('./accountplus/tx.rpc.msg.js')).MsgClientImpl(rpc),
        affiliates: new (await import('./affiliates/tx.rpc.msg.js')).MsgClientImpl(rpc),
        blocktime: new (await import('./blocktime/tx.rpc.msg.js')).MsgClientImpl(rpc),
        ...
        perpetuals: new (await import('./perpetuals/tx.rpc.msg.js')).MsgClientImpl(rpc),
        prices: new (await import('./prices/tx.rpc.msg.js')).MsgClientImpl(rpc),
        ratelimit: new (await import('./ratelimit/tx.rpc.msg.js')).MsgClientImpl(rpc),
