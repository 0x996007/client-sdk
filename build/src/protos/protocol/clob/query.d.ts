...
import { ValidatorMevMatches, ValidatorMevMatchesSDKType, MevNodeToNodeMetrics, MevNodeToNodeMetricsSDKType } from './mev.js';
import { OrderId, OrderIdSDKType, LongTermOrderPlacement, LongTermOrderPlacementSDKType, Order, OrderSDKType, StreamLiquidationOrder, StreamLiquidationOrderSDKType } from './order.js';
...
import { OffChainUpdateV1, OffChainUpdateV1SDKType } from '../indexer/off_chain_updates/off_chain_updates.js';
...
export declare const QueryNextClobPairIdRequest: {
    encode(_: QueryNextClobPairIdRequest, writer?: _m0.Writer): _m0.Writer;
...
export declare const QueryNextClobPairIdResponse: {
    encode(message: QueryNextClobPairIdResponse, writer?: _m0.Writer): _m0.Writer;
