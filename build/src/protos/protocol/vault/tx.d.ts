...
import { QuotingParams, QuotingParamsSDKType, OperatorParams, OperatorParamsSDKType, VaultParams, VaultParamsSDKType, Params, ParamsSDKType } from './params.js';
...
export declare const MsgSetVaultQuotingParams: {
    encode(message: MsgSetVaultQuotingParams, writer?: _m0.Writer): _m0.Writer;
