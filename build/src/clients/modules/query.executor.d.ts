...
export declare class QueryExecutor {
    ...
    constructor(tendermintClient: WarpedTendermintClient, stargateQueryClient: StargateQueryClient & TxExtension);
    /**
     ...
     * @returns All unbonding delegations from a delegator.
     */
    getDelegationTotalRewards(delegatorAddress: string): Promise<DistributionModule.QueryDelegationTotalRewardsResponse>;
    /**
     ...
     */
    getAllGovProposals(proposalStatus?: ProposalStatus, voter?: string, depositor?: string): Promise<GovV1Module.QueryProposalsResponse>;
    getWithdrawalAndTransferGatingStatus(perpetualId: number): Promise<SubaccountsModule.QueryGetWithdrawalAndTransfersBlockedInfoResponse>;
    getWithdrawalCapacityByDenom(denom: string): Promise<RateLimitModule.QueryCapacityByDenomResponse>;
    getMegavaultOwnerShares(address: string): Promise<VaultModule.QueryMegavaultOwnerSharesResponse>;
    getMegavaultWithdrawalInfo(sharesToWithdraw: bigint): Promise<VaultModule.QueryMegavaultWithdrawalInfoResponse>;
    getAffiliateInfo(address: string): Promise<AffiliateModule.AffiliateInfoResponse>;
    getReferredBy(address: string): Promise<AffiliateModule.ReferredByResponse>;
    getAllAffiliateTiers(): Promise<AffiliateModule.AllAffiliateTiersResponse>;
    getAffiliateWhitelist(): Promise<AffiliateModule.AffiliateWhitelistResponse>;
    private sendQuery;
}
