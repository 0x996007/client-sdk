...
import {
  ...
  QueryInflationResponseSDKType,
  QueryAnnualProvisionsRequest,
  QueryAnnualProvisionsResponseSDKType,
} from './query.js';
export class LCDQueryClient {
  ...
  async inflation(
    _params: QueryInflationRequest = {},
  ): Promise<QueryInflationResponseSDKType> {
  ...
  ): Promise<QueryAnnualProvisionsResponseSDKType> {
