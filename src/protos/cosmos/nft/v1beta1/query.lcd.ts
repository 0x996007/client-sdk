...
import {
  ...
  QueryOwnerRequest,
  QueryOwnerResponseSDKType,
  QuerySupplyRequest,
  QuerySupplyResponseSDKType,
  QueryNFTsRequest,
  QueryNFTsResponseSDKType,
  QueryNFTRequest,
  QueryNFTResponseSDKType,
  QueryClassRequest,
  QueryClassResponseSDKType,
  QueryClassesRequest,
...
export class LCDQueryClient {
  ...
  async supply(
    params: QuerySupplyRequest,
  ): Promise<QuerySupplyResponseSDKType> {
