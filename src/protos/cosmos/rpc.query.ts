...
export const createRPCQueryClient = async ({
  ...
  return {
    cosmos: {
      app: {
        v1alpha1: (
          await import('./app/v1alpha1/query.rpc.Query.js')
      ...
      base: {
        ...
        tendermint: {
          v1beta1: (
            await import('./base/tendermint/v1beta1/query.rpc.Service.js')
          ).createRpcQueryExtension(client),
        },
      },
      circuit: {
      ...
      evidence: {
        v1beta1: (
          await import('./evidence/v1beta1/query.rpc.Query.js')
        ).createRpcQueryExtension(client),
      },
      feegrant: {
        v1beta1: (
      ...
      nft: {
        v1beta1: (
          await import('./nft/v1beta1/query.rpc.Query.js')
        ).createRpcQueryExtension(client),
      },
      orm: {
        query: {
          v1alpha1: (
            await import('./orm/query/v1alpha1/query.rpc.Query.js')
          ).createRpcQueryExtension(client),
        },
      },
      params: {
      ...
      slashing: {
        v1beta1: (
          await import('./slashing/v1beta1/query.rpc.Query.js')
        ).createRpcQueryExtension(client),
      },
      staking: {
        v1beta1: (
