...
import {
  ...
  GetSyncingRequest,
  GetSyncingResponseSDKType,
  GetLatestBlockRequest,
  GetLatestBlockResponseSDKType,
  GetBlockByHeightRequest,
  GetBlockByHeightResponseSDKType,
  GetLatestValidatorSetRequest,
  GetLatestValidatorSetResponseSDKType,
  GetValidatorSetByHeightRequest,
  GetValidatorSetByHeightResponseSDKType,
  ABCIQueryRequest,
  ABCIQueryResponseSDKType,
} from './query.js';
export class LCDQueryClient {
  ...
  async getNodeInfo(
    _params: GetNodeInfoRequest = {},
  ): Promise<GetNodeInfoResponseSDKType> {
  ...
  async getSyncing(
    _params: GetSyncingRequest = {},
  ): Promise<GetSyncingResponseSDKType> {
  ...
  async getLatestBlock(
    _params: GetLatestBlockRequest = {},
  ): Promise<GetLatestBlockResponseSDKType> {
  ...
  async getBlockByHeight(
    params: GetBlockByHeightRequest,
  ): Promise<GetBlockByHeightResponseSDKType> {
  ...
  async getLatestValidatorSet(
    params: GetLatestValidatorSetRequest = {
    ...
    return await this.req.get<GetLatestValidatorSetResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async getValidatorSetByHeight(
  ...
  ): Promise<GetValidatorSetByHeightResponseSDKType> {
    const options: any = {
      params: {},
    };
    ...
    return await this.req.get<GetValidatorSetByHeightResponseSDKType>(
      endpoint,
      options,
    );
  }
