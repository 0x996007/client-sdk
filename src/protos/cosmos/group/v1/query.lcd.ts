...
import {
  ...
  QueryGroupPolicyInfoResponseSDKType,
  QueryGroupMembersRequest,
  QueryGroupMembersResponseSDKType,
  QueryGroupsByAdminRequest,
  QueryGroupsByAdminResponseSDKType,
  QueryGroupPoliciesByGroupRequest,
  QueryGroupPoliciesByGroupResponseSDKType,
  QueryGroupPoliciesByAdminRequest,
  QueryGroupPoliciesByAdminResponseSDKType,
  QueryProposalRequest,
  QueryProposalResponseSDKType,
  QueryProposalsByGroupPolicyRequest,
  QueryProposalsByGroupPolicyResponseSDKType,
  QueryVoteByProposalVoterRequest,
  QueryVoteByProposalVoterResponseSDKType,
  QueryVotesByProposalRequest,
  QueryVotesByProposalResponseSDKType,
  QueryVotesByVoterRequest,
  QueryVotesByVoterResponseSDKType,
  QueryGroupsByMemberRequest,
  QueryGroupsByMemberResponseSDKType,
  QueryTallyResultRequest,
  QueryTallyResultResponseSDKType,
  QueryGroupsRequest,
  QueryGroupsResponseSDKType,
} from './query.js';
export class LCDQueryClient {
  ...
  ): Promise<QueryGroupInfoResponseSDKType> {
  ...
  ): Promise<QueryGroupPolicyInfoResponseSDKType> {
  ...
  async groupMembers(
  ...
  ): Promise<QueryGroupMembersResponseSDKType> {
    const options: any = {
      params: {},
    };
    ...
    return await this.req.get<QueryGroupMembersResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async groupsByAdmin(
  ...
  ): Promise<QueryGroupsByAdminResponseSDKType> {
    const options: any = {
      params: {},
    };
    ...
    return await this.req.get<QueryGroupsByAdminResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async groupPoliciesByGroup(
  ...
  ): Promise<QueryGroupPoliciesByGroupResponseSDKType> {
    const options: any = {
      params: {},
    };
    ...
    return await this.req.get<QueryGroupPoliciesByGroupResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async groupPoliciesByAdmin(
  ...
  ): Promise<QueryGroupPoliciesByAdminResponseSDKType> {
    const options: any = {
      params: {},
    };
    ...
    return await this.req.get<QueryGroupPoliciesByAdminResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async proposalsByGroupPolicy(
  ...
  ): Promise<QueryProposalsByGroupPolicyResponseSDKType> {
    const options: any = {
      params: {},
    };
    ...
    return await this.req.get<QueryProposalsByGroupPolicyResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  ): Promise<QueryVoteByProposalVoterResponseSDKType> {
    const endpoint = `cosmos/group/v1/vote_by_proposal_voter/${params.proposalId}/${params.voter}`;
    return await this.req.get<QueryVoteByProposalVoterResponseSDKType>(
      endpoint,
    );
  }
  ...
  async votesByProposal(
  ...
  ): Promise<QueryVotesByProposalResponseSDKType> {
    const options: any = {
      params: {},
    };
    ...
    return await this.req.get<QueryVotesByProposalResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async votesByVoter(
  ...
  ): Promise<QueryVotesByVoterResponseSDKType> {
    const options: any = {
      params: {},
    };
    ...
    return await this.req.get<QueryVotesByVoterResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async groupsByMember(
  ...
  ): Promise<QueryGroupsByMemberResponseSDKType> {
    const options: any = {
      params: {},
    };
    ...
    return await this.req.get<QueryGroupsByMemberResponseSDKType>(
      endpoint,
      options,
    );
  }
