...
export interface Query {
  ...
  statsMetadata(
    request?: QueryStatsMetadataRequest,
  ): Promise<QueryStatsMetadataResponse>;
  /** Queries GlobalStats. */

  globalStats(
    request?: QueryGlobalStatsRequest,
  ): Promise<QueryGlobalStatsResponse>;
  /** Queries UserStats. */
...
export class QueryClientImpl implements Query {
  ...
  statsMetadata(
    ...
    return promise.then((data) =>
      QueryStatsMetadataResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  globalStats(
    ...
    return promise.then((data) =>
      QueryGlobalStatsResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  userStats(request: QueryUserStatsRequest): Promise<QueryUserStatsResponse> {
    ...
    return promise.then((data) =>
      QueryUserStatsResponse.decode(new _m0.Reader(data)),
    );
  }
}
