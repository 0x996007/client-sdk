...
export const QueryStatsMetadataRequest = {
  ...
  fromPartial(
    _: DeepPartial<QueryStatsMetadataRequest>,
  ): QueryStatsMetadataRequest {
    const message = createBaseQueryStatsMetadataRequest();
    return message;
  },
...
export const QueryStatsMetadataResponse = {
  encode(
    message: QueryStatsMetadataResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
  ...
  fromPartial(
    object: DeepPartial<QueryStatsMetadataResponse>,
  ): QueryStatsMetadataResponse {
    const message = createBaseQueryStatsMetadataResponse();
    message.metadata =
...
export const QueryGlobalStatsRequest = {
  ...
  fromPartial(
    _: DeepPartial<QueryGlobalStatsRequest>,
  ): QueryGlobalStatsRequest {
    const message = createBaseQueryGlobalStatsRequest();
    return message;
  },
...
export const QueryGlobalStatsResponse = {
  encode(
    message: QueryGlobalStatsResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
  ...
  fromPartial(
    object: DeepPartial<QueryGlobalStatsResponse>,
  ): QueryGlobalStatsResponse {
    const message = createBaseQueryGlobalStatsResponse();
    message.stats =
...
export const QueryUserStatsRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryUserStatsRequest>,
  ): QueryUserStatsRequest {
    const message = createBaseQueryUserStatsRequest();
...
export const QueryUserStatsResponse = {
  encode(
    message: QueryUserStatsResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    if (message.stats !== undefined) {
  ...
  fromPartial(
    object: DeepPartial<QueryUserStatsResponse>,
  ): QueryUserStatsResponse {
    const message = createBaseQueryUserStatsResponse();
    message.stats =
      object.stats !== undefined && object.stats !== null
