...
import {
  ...
  QueryStatsMetadataResponseSDKType,
  QueryGlobalStatsRequest,
  QueryGlobalStatsResponseSDKType,
...
export class LCDQueryClient {
  ...
  async statsMetadata(
    _params: QueryStatsMetadataRequest = {},
  ): Promise<QueryStatsMetadataResponseSDKType> {
  ...
  async globalStats(
    _params: QueryGlobalStatsRequest = {},
  ): Promise<QueryGlobalStatsResponseSDKType> {
  ...
  async userStats(
    params: QueryUserStatsRequest,
  ): Promise<QueryUserStatsResponseSDKType> {
    const options: any = {
      params: {},
    };
