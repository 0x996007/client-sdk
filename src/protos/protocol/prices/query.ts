...
export const QueryMarketPriceRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryMarketPriceRequest>,
  ): QueryMarketPriceRequest {
    const message = createBaseQueryMarketPriceRequest();
...
export const QueryMarketPriceResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryMarketPriceResponse>,
  ): QueryMarketPriceResponse {
    const message = createBaseQueryMarketPriceResponse();
    message.marketPrice =
...
export const QueryAllMarketPricesRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryAllMarketPricesRequest>,
  ): QueryAllMarketPricesRequest {
    const message = createBaseQueryAllMarketPricesRequest();
    message.pagination =
...
export const QueryAllMarketPricesResponse = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.marketPrices.push(
            MarketPrice.decode(reader, reader.uint32()),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<QueryAllMarketPricesResponse>,
  ): QueryAllMarketPricesResponse {
    const message = createBaseQueryAllMarketPricesResponse();
...
export const QueryMarketParamRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryMarketParamRequest>,
  ): QueryMarketParamRequest {
    const message = createBaseQueryMarketParamRequest();
    message.id = object.id ?? 0;
    return message;
...
export const QueryMarketParamResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryMarketParamResponse>,
  ): QueryMarketParamResponse {
    const message = createBaseQueryMarketParamResponse();
    message.marketParam =
...
export const QueryAllMarketParamsRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryAllMarketParamsRequest>,
  ): QueryAllMarketParamsRequest {
    const message = createBaseQueryAllMarketParamsRequest();
    message.pagination =
      object.pagination !== undefined && object.pagination !== null
...
export const QueryAllMarketParamsResponse = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.marketParams.push(
            MarketParam.decode(reader, reader.uint32()),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<QueryAllMarketParamsResponse>,
  ): QueryAllMarketParamsResponse {
    const message = createBaseQueryAllMarketParamsResponse();
...
export const QueryNextMarketIdRequest = {
  ...
  fromPartial(
    _: DeepPartial<QueryNextMarketIdRequest>,
  ): QueryNextMarketIdRequest {
    const message = createBaseQueryNextMarketIdRequest();
    return message;
  },
...
export const QueryNextMarketIdResponse = {
  encode(
    message: QueryNextMarketIdResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
  ...
  fromPartial(
    object: DeepPartial<QueryNextMarketIdResponse>,
  ): QueryNextMarketIdResponse {
    const message = createBaseQueryNextMarketIdResponse();
