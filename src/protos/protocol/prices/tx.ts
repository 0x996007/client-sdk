...
export const MsgCreateOracleMarket = {
  ...
  fromPartial(
    object: DeepPartial<MsgCreateOracleMarket>,
  ): MsgCreateOracleMarket {
    const message = createBaseMsgCreateOracleMarket();
...
export const MsgCreateOracleMarketResponse = {
  encode(
    _: MsgCreateOracleMarketResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<MsgCreateOracleMarketResponse>,
  ): MsgCreateOracleMarketResponse {
    const message = createBaseMsgCreateOracleMarketResponse();
    return message;
  },
...
export const MsgUpdateMarketPrices = {
  encode(
    ...
    for (const v of message.marketPriceUpdates) {
      MsgUpdateMarketPrices_MarketPrice.encode(
        v!,
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.marketPriceUpdates.push(
            MsgUpdateMarketPrices_MarketPrice.decode(reader, reader.uint32()),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<MsgUpdateMarketPrices>,
  ): MsgUpdateMarketPrices {
    const message = createBaseMsgUpdateMarketPrices();
    message.marketPriceUpdates =
      object.marketPriceUpdates?.map((e) =>
        MsgUpdateMarketPrices_MarketPrice.fromPartial(e),
      ) || [];
    return message;
  },
};
...
export const MsgUpdateMarketPrices_MarketPrice = {
  encode(
    message: MsgUpdateMarketPrices_MarketPrice,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
  ...
  fromPartial(
    object: DeepPartial<MsgUpdateMarketPrices_MarketPrice>,
  ): MsgUpdateMarketPrices_MarketPrice {
    const message = createBaseMsgUpdateMarketPrices_MarketPrice();
...
export const MsgUpdateMarketPricesResponse = {
  encode(
    _: MsgUpdateMarketPricesResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<MsgUpdateMarketPricesResponse>,
  ): MsgUpdateMarketPricesResponse {
    const message = createBaseMsgUpdateMarketPricesResponse();
    return message;
  },
...
export const MsgUpdateMarketParamResponse = {
  encode(
    _: MsgUpdateMarketParamResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<MsgUpdateMarketParamResponse>,
  ): MsgUpdateMarketParamResponse {
    const message = createBaseMsgUpdateMarketParamResponse();
    return message;
  },
