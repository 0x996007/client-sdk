...
import {
  ...
  QueryMarketPriceResponseSDKType,
  QueryAllMarketPricesRequest,
  QueryAllMarketPricesResponseSDKType,
  QueryMarketParamRequest,
  QueryMarketParamResponseSDKType,
  QueryAllMarketParamsRequest,
  QueryAllMarketParamsResponseSDKType,
  QueryNextMarketIdRequest,
  QueryNextMarketIdResponseSDKType,
} from './query.js';
export class LCDQueryClient {
  ...
  async marketPrice(
    params: QueryMarketPriceRequest,
  ): Promise<QueryMarketPriceResponseSDKType> {
  ...
  async allMarketPrices(
    params: QueryAllMarketPricesRequest = {
    ...
    return await this.req.get<QueryAllMarketPricesResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async marketParam(
    params: QueryMarketParamRequest,
  ): Promise<QueryMarketParamResponseSDKType> {
  ...
  async allMarketParams(
    params: QueryAllMarketParamsRequest = {
      pagination: undefined,
    },
    ...
    return await this.req.get<QueryAllMarketParamsResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async nextMarketId(
    _params: QueryNextMarketIdRequest = {},
  ): Promise<QueryNextMarketIdResponseSDKType> {
