...
export interface Msg {
   ...
   */
  updateMarketPrices(
    request: MsgUpdateMarketPrices,
  ): Promise<MsgUpdateMarketPricesResponse>;
  /** CreateOracleMarket creates a new oracle market. */

  createOracleMarket(
    request: MsgCreateOracleMarket,
  ): Promise<MsgCreateOracleMarketResponse>;
  /**
  ...
  updateMarketParam(
    request: MsgUpdateMarketParam,
  ): Promise<MsgUpdateMarketParamResponse>;
}
export class MsgClientImpl implements Msg {
  ...
  updateMarketPrices(
    ...
    const promise = this.rpc.request(
      'dydxprotocol.prices.Msg',
      'UpdateMarketPrices',
      data,
    );
    return promise.then((data) =>
      MsgUpdateMarketPricesResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  createOracleMarket(
    ...
    return promise.then((data) =>
      MsgCreateOracleMarketResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  updateMarketParam(
    ...
    return promise.then((data) =>
      MsgUpdateMarketParamResponse.decode(new _m0.Reader(data)),
    );
  }
}
