...
export interface Query {
  ...
  marketPrice(
    request: QueryMarketPriceRequest,
  ): Promise<QueryMarketPriceResponse>;
  /** Queries a list of MarketPrice items. */

  allMarketPrices(
    request?: QueryAllMarketPricesRequest,
  ): Promise<QueryAllMarketPricesResponse>;
  /** Queries a MarketParam by id. */

  marketParam(
    request: QueryMarketParamRequest,
  ): Promise<QueryMarketParamResponse>;
  /** Queries a list of MarketParam items. */

  allMarketParams(
    request?: QueryAllMarketParamsRequest,
  ): Promise<QueryAllMarketParamsResponse>;
  /** Queries the next market id. */

  nextMarketId(
    request?: QueryNextMarketIdRequest,
  ): Promise<QueryNextMarketIdResponse>;
}
export class QueryClientImpl implements Query {
  ...
  marketPrice(
    ...
    const promise = this.rpc.request(
      'dydxprotocol.prices.Query',
      'MarketPrice',
      data,
    );
    return promise.then((data) =>
      QueryMarketPriceResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  allMarketPrices(
    ...
    return promise.then((data) =>
      QueryAllMarketPricesResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  marketParam(
    ...
    return promise.then((data) =>
      QueryMarketParamResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  allMarketParams(
    ...
    return promise.then((data) =>
      QueryAllMarketParamsResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  nextMarketId(
    ...
    return promise.then((data) =>
      QueryNextMarketIdResponse.decode(new _m0.Reader(data)),
    );
  }
}
