...
import { IndexerOrder, IndexerOrderSDKType } from '../protocol/v1/clob.js';
...
export function redisOrder_TickerTypeFromJSON(
  object: any,
...
export function redisOrder_TickerTypeToJSON(
  object: RedisOrder_TickerType,
): string {
  switch (object) {
