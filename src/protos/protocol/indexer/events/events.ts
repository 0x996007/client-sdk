...
import {
  IndexerSubaccountId,
  IndexerSubaccountIdSDKType,
  IndexerPerpetualPosition,
  IndexerPerpetualPositionSDKType,
  IndexerAssetPosition,
  IndexerAssetPositionSDKType,
} from '../protocol/v1/subaccount.js';
import {
  IndexerOrder,
  IndexerOrderSDKType,
  IndexerOrderId,
  IndexerOrderIdSDKType,
  ClobPairStatus,
} from '../protocol/v1/clob.js';
...
export const MarketEventV1 = {
  encode(
    ...
    if (message.priceUpdate !== undefined) {
      MarketPriceUpdateEventV1.encode(
        message.priceUpdate,
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MarketEventV1 {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          message.priceUpdate = MarketPriceUpdateEventV1.decode(
            reader,
            reader.uint32(),
          );
          break;
        ...
        case 3:
          message.marketCreate = MarketCreateEventV1.decode(
            reader,
            reader.uint32(),
          );
          break;
        ...
        case 4:
          message.marketModify = MarketModifyEventV1.decode(
            reader,
            reader.uint32(),
          );
          break;
...
export const MarketPriceUpdateEventV1 = {
  ...
  fromPartial(
    object: DeepPartial<MarketPriceUpdateEventV1>,
  ): MarketPriceUpdateEventV1 {
    const message = createBaseMarketPriceUpdateEventV1();
...
export const SourceOfFunds = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SourceOfFunds {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.subaccountId = IndexerSubaccountId.decode(
            reader,
            reader.uint32(),
          );
          break;
...
export const TransferEventV1 = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): TransferEventV1 {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.senderSubaccountId = IndexerSubaccountId.decode(
            reader,
            reader.uint32(),
          );
          break;
        ...
        case 2:
          message.recipientSubaccountId = IndexerSubaccountId.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): OrderFillEventV1 {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          message.liquidationOrder = LiquidationOrderV1.decode(
            reader,
            reader.uint32(),
          );
          break;
...
export const DeleveragingEventV1 = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DeleveragingEventV1 {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.liquidated = IndexerSubaccountId.decode(
            reader,
            reader.uint32(),
          );
          break;
        ...
        case 2:
          message.offsetting = IndexerSubaccountId.decode(
            reader,
            reader.uint32(),
          );
          break;
...
export const SubaccountUpdateEventV1 = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          message.updatedPerpetualPositions.push(
            IndexerPerpetualPosition.decode(reader, reader.uint32()),
          );
          break;

        case 4:
          message.updatedAssetPositions.push(
            IndexerAssetPosition.decode(reader, reader.uint32()),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<SubaccountUpdateEventV1>,
  ): SubaccountUpdateEventV1 {
    const message = createBaseSubaccountUpdateEventV1();
    message.subaccountId =
      object.subaccountId !== undefined && object.subaccountId !== null
    ...
    message.updatedPerpetualPositions =
      object.updatedPerpetualPositions?.map((e) =>
        IndexerPerpetualPosition.fromPartial(e),
      ) || [];
    message.updatedAssetPositions =
      object.updatedAssetPositions?.map((e) =>
        IndexerAssetPosition.fromPartial(e),
      ) || [];
    return message;
  },
};
...
export const StatefulOrderEventV1 = {
  encode(
    ...
    if (message.orderPlace !== undefined) {
      StatefulOrderEventV1_StatefulOrderPlacementV1.encode(
        message.orderPlace,
        writer.uint32(10).fork(),
      ).ldelim();
    }
    ...
    if (message.orderRemoval !== undefined) {
      StatefulOrderEventV1_StatefulOrderRemovalV1.encode(
    ...
    if (message.conditionalOrderPlacement !== undefined) {
      StatefulOrderEventV1_ConditionalOrderPlacementV1.encode(
    ...
    if (message.conditionalOrderTriggered !== undefined) {
      StatefulOrderEventV1_ConditionalOrderTriggeredV1.encode(
    ...
    if (message.longTermOrderPlacement !== undefined) {
      StatefulOrderEventV1_LongTermOrderPlacementV1.encode(
    ...
    if (message.orderReplacement !== undefined) {
      StatefulOrderEventV1_LongTermOrderReplacementV1.encode(
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.orderPlace =
            StatefulOrderEventV1_StatefulOrderPlacementV1.decode(
              reader,
              reader.uint32(),
            );
          break;
        ...
        case 4:
          message.orderRemoval =
            StatefulOrderEventV1_StatefulOrderRemovalV1.decode(
              reader,
              reader.uint32(),
            );
          break;
        ...
        case 5:
          message.conditionalOrderPlacement =
            StatefulOrderEventV1_ConditionalOrderPlacementV1.decode(
              reader,
              reader.uint32(),
            );
          break;
        ...
        case 6:
          message.conditionalOrderTriggered =
            StatefulOrderEventV1_ConditionalOrderTriggeredV1.decode(
              reader,
              reader.uint32(),
            );
          break;
        ...
        case 7:
          message.longTermOrderPlacement =
            StatefulOrderEventV1_LongTermOrderPlacementV1.decode(
              reader,
              reader.uint32(),
            );
          break;
        ...
        case 8:
          message.orderReplacement =
            StatefulOrderEventV1_LongTermOrderReplacementV1.decode(
              reader,
              reader.uint32(),
            );
          break;
  ...
  fromPartial(object: DeepPartial<StatefulOrderEventV1>): StatefulOrderEventV1 {
    ...
    message.orderPlace =
      object.orderPlace !== undefined && object.orderPlace !== null
        ? StatefulOrderEventV1_StatefulOrderPlacementV1.fromPartial(
            object.orderPlace,
          )
        : undefined;
    message.orderRemoval =
      object.orderRemoval !== undefined && object.orderRemoval !== null
        ? StatefulOrderEventV1_StatefulOrderRemovalV1.fromPartial(
            object.orderRemoval,
          )
        : undefined;
    message.conditionalOrderPlacement =
      ...
      object.conditionalOrderPlacement !== null
        ? StatefulOrderEventV1_ConditionalOrderPlacementV1.fromPartial(
            object.conditionalOrderPlacement,
          )
        : undefined;
    message.conditionalOrderTriggered =
      object.conditionalOrderTriggered !== undefined &&
      object.conditionalOrderTriggered !== null
        ? StatefulOrderEventV1_ConditionalOrderTriggeredV1.fromPartial(
            object.conditionalOrderTriggered,
          )
        : undefined;
    message.longTermOrderPlacement =
      object.longTermOrderPlacement !== undefined &&
      object.longTermOrderPlacement !== null
        ? StatefulOrderEventV1_LongTermOrderPlacementV1.fromPartial(
            object.longTermOrderPlacement,
          )
        : undefined;
    message.orderReplacement =
      object.orderReplacement !== undefined && object.orderReplacement !== null
        ? StatefulOrderEventV1_LongTermOrderReplacementV1.fromPartial(
            object.orderReplacement,
          )
        : undefined;
    return message;
  },
...
export const StatefulOrderEventV1_StatefulOrderPlacementV1 = {
  encode(
    message: StatefulOrderEventV1_StatefulOrderPlacementV1,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    if (message.order !== undefined) {
  ...
  fromPartial(
    object: DeepPartial<StatefulOrderEventV1_StatefulOrderPlacementV1>,
  ): StatefulOrderEventV1_StatefulOrderPlacementV1 {
    const message = createBaseStatefulOrderEventV1_StatefulOrderPlacementV1();
    message.order =
      object.order !== undefined && object.order !== null
...
export const StatefulOrderEventV1_StatefulOrderRemovalV1 = {
  encode(
    message: StatefulOrderEventV1_StatefulOrderRemovalV1,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    if (message.removedOrderId !== undefined) {
      IndexerOrderId.encode(
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.removedOrderId = IndexerOrderId.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<StatefulOrderEventV1_StatefulOrderRemovalV1>,
  ): StatefulOrderEventV1_StatefulOrderRemovalV1 {
    const message = createBaseStatefulOrderEventV1_StatefulOrderRemovalV1();
    message.removedOrderId =
...
export const StatefulOrderEventV1_ConditionalOrderPlacementV1 = {
  encode(
    message: StatefulOrderEventV1_ConditionalOrderPlacementV1,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    if (message.order !== undefined) {
      IndexerOrder.encode(message.order, writer.uint32(10).fork()).ldelim();
  ...
  decode(
    ...
    const end = length === undefined ? reader.len : reader.pos + length;
    const message =
      createBaseStatefulOrderEventV1_ConditionalOrderPlacementV1();
  ...
  fromPartial(
    object: DeepPartial<StatefulOrderEventV1_ConditionalOrderPlacementV1>,
  ): StatefulOrderEventV1_ConditionalOrderPlacementV1 {
    const message =
      createBaseStatefulOrderEventV1_ConditionalOrderPlacementV1();
    message.order =
...
export const StatefulOrderEventV1_ConditionalOrderTriggeredV1 = {
  encode(
    message: StatefulOrderEventV1_ConditionalOrderTriggeredV1,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
  ...
  decode(
    ...
    const end = length === undefined ? reader.len : reader.pos + length;
    const message =
      createBaseStatefulOrderEventV1_ConditionalOrderTriggeredV1();
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.triggeredOrderId = IndexerOrderId.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<StatefulOrderEventV1_ConditionalOrderTriggeredV1>,
  ): StatefulOrderEventV1_ConditionalOrderTriggeredV1 {
    const message =
      createBaseStatefulOrderEventV1_ConditionalOrderTriggeredV1();
    message.triggeredOrderId =
...
export const StatefulOrderEventV1_LongTermOrderPlacementV1 = {
  encode(
    message: StatefulOrderEventV1_LongTermOrderPlacementV1,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    if (message.order !== undefined) {
      IndexerOrder.encode(message.order, writer.uint32(10).fork()).ldelim();
  ...
  fromPartial(
    object: DeepPartial<StatefulOrderEventV1_LongTermOrderPlacementV1>,
  ): StatefulOrderEventV1_LongTermOrderPlacementV1 {
    const message = createBaseStatefulOrderEventV1_LongTermOrderPlacementV1();
    message.order =
      object.order !== undefined && object.order !== null
...
export const StatefulOrderEventV1_LongTermOrderReplacementV1 = {
  encode(
    message: StatefulOrderEventV1_LongTermOrderReplacementV1,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
  ...
  fromPartial(
    object: DeepPartial<StatefulOrderEventV1_LongTermOrderReplacementV1>,
  ): StatefulOrderEventV1_LongTermOrderReplacementV1 {
    const message = createBaseStatefulOrderEventV1_LongTermOrderReplacementV1();
    message.oldOrderId =
...
export const PerpetualMarketCreateEventV1 = {
  ...
  fromPartial(
    object: DeepPartial<PerpetualMarketCreateEventV1>,
  ): PerpetualMarketCreateEventV1 {
    const message = createBasePerpetualMarketCreateEventV1();
    message.id = object.id ?? 0;
    message.clobPairId = object.clobPairId ?? 0;
...
export const PerpetualMarketCreateEventV2 = {
  ...
  fromPartial(
    object: DeepPartial<PerpetualMarketCreateEventV2>,
  ): PerpetualMarketCreateEventV2 {
    const message = createBasePerpetualMarketCreateEventV2();
    message.id = object.id ?? 0;
    message.clobPairId = object.clobPairId ?? 0;
...
export const LiquidityTierUpsertEventV1 = {
  ...
  fromPartial(
    object: DeepPartial<LiquidityTierUpsertEventV1>,
  ): LiquidityTierUpsertEventV1 {
    const message = createBaseLiquidityTierUpsertEventV1();
    message.id = object.id ?? 0;
...
export const UpdateClobPairEventV1 = {
  ...
  fromPartial(
    object: DeepPartial<UpdateClobPairEventV1>,
  ): UpdateClobPairEventV1 {
    const message = createBaseUpdateClobPairEventV1();
    message.clobPairId = object.clobPairId ?? 0;
    message.status = object.status ?? 0;
...
export const UpdatePerpetualEventV1 = {
  ...
  fromPartial(
    object: DeepPartial<UpdatePerpetualEventV1>,
  ): UpdatePerpetualEventV1 {
    const message = createBaseUpdatePerpetualEventV1();
    message.id = object.id ?? 0;
    message.ticker = object.ticker ?? '';
...
export const UpdatePerpetualEventV2 = {
  ...
  fromPartial(
    object: DeepPartial<UpdatePerpetualEventV2>,
  ): UpdatePerpetualEventV2 {
    const message = createBaseUpdatePerpetualEventV2();
    message.id = object.id ?? 0;
    message.ticker = object.ticker ?? '';
...
export const TradingRewardsEventV1 = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.tradingRewards.push(
            AddressTradingReward.decode(reader, reader.uint32()),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<TradingRewardsEventV1>,
  ): TradingRewardsEventV1 {
    const message = createBaseTradingRewardsEventV1();
...
export const OpenInterestUpdateEventV1 = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.openInterestUpdates.push(
            OpenInterestUpdate.decode(reader, reader.uint32()),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<OpenInterestUpdateEventV1>,
  ): OpenInterestUpdateEventV1 {
    const message = createBaseOpenInterestUpdateEventV1();
    message.openInterestUpdates =
      object.openInterestUpdates?.map((e) =>
        OpenInterestUpdate.fromPartial(e),
      ) || [];
    return message;
  },
};
...
export const LiquidityTierUpsertEventV2 = {
  ...
  fromPartial(
    object: DeepPartial<LiquidityTierUpsertEventV2>,
  ): LiquidityTierUpsertEventV2 {
    const message = createBaseLiquidityTierUpsertEventV2();
    message.id = object.id ?? 0;
    message.name = object.name ?? '';
...
export const RegisterAffiliateEventV1 = {
  ...
  fromPartial(
    object: DeepPartial<RegisterAffiliateEventV1>,
  ): RegisterAffiliateEventV1 {
    const message = createBaseRegisterAffiliateEventV1();
