...
export function indexerOrder_TimeInForceFromJSON(
  object: any,
...
export function indexerOrder_ConditionTypeFromJSON(
  object: any,
...
export function indexerOrder_ConditionTypeToJSON(
  object: IndexerOrder_ConditionType,
): string {
  switch (object) {
