...
export const OrderPlaceV1_OrderPlacementStatusSDKType =
  OrderPlaceV1_OrderPlacementStatus;
export function orderPlaceV1_OrderPlacementStatusFromJSON(
  object: any,
): OrderPlaceV1_OrderPlacementStatus {
  switch (object) {
    case 0:
...
export function orderPlaceV1_OrderPlacementStatusToJSON(
  object: OrderPlaceV1_OrderPlacementStatus,
): string {
  switch (object) {
...
export const OrderRemoveV1_OrderRemovalStatusSDKType =
...
export function orderRemoveV1_OrderRemovalStatusToJSON(
  object: OrderRemoveV1_OrderRemovalStatus,
): string {
  switch (object) {
