...
import { DeepPartial, toTimestamp, fromTimestamp } from '../../../helpers.js';
...
export const IndexerTendermintEvent_BlockEventSDKType =
  IndexerTendermintEvent_BlockEvent;
export function indexerTendermintEvent_BlockEventFromJSON(
  object: any,
): IndexerTendermintEvent_BlockEvent {
  switch (object) {
    case 0:
...
export function indexerTendermintEvent_BlockEventToJSON(
  object: IndexerTendermintEvent_BlockEvent,
): string {
  switch (object) {
...
export const IndexerTendermintEventWrapper = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.event = IndexerTendermintEvent.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<IndexerTendermintEventWrapper>,
  ): IndexerTendermintEventWrapper {
    const message = createBaseIndexerTendermintEventWrapper();
    message.event =
...
export const IndexerEventsStoreValue = {
  encode(
    ...
    for (const v of message.events) {
      IndexerTendermintEventWrapper.encode(
        v!,
        writer.uint32(10).fork(),
      ).ldelim();
    }
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.events.push(
            IndexerTendermintEventWrapper.decode(reader, reader.uint32()),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<IndexerEventsStoreValue>,
  ): IndexerEventsStoreValue {
    const message = createBaseIndexerEventsStoreValue();
    message.events =
...
export const IndexerTendermintEvent = {
  ...
  fromPartial(
    object: DeepPartial<IndexerTendermintEvent>,
  ): IndexerTendermintEvent {
    const message = createBaseIndexerTendermintEvent();
...
export const IndexerTendermintBlock = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          message.events.push(
            IndexerTendermintEvent.decode(reader, reader.uint32()),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<IndexerTendermintBlock>,
  ): IndexerTendermintBlock {
    const message = createBaseIndexerTendermintBlock();
