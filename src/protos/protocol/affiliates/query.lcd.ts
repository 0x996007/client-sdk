...
import {
  ...
  AffiliateInfoResponseSDKType,
  ReferredByRequest,
  ReferredByResponseSDKType,
  AllAffiliateTiersRequest,
  AllAffiliateTiersResponseSDKType,
  AffiliateWhitelistRequest,
  AffiliateWhitelistResponseSDKType,
} from './query.js';
export class LCDQueryClient {
  ...
  async affiliateInfo(
    params: AffiliateInfoRequest,
  ): Promise<AffiliateInfoResponseSDKType> {
  ...
  async referredBy(
    params: ReferredByRequest,
  ): Promise<ReferredByResponseSDKType> {
  ...
  async allAffiliateTiers(
    _params: AllAffiliateTiersRequest = {},
  ): Promise<AllAffiliateTiersResponseSDKType> {
  ...
  async affiliateWhitelist(
    _params: AffiliateWhitelistRequest = {},
  ): Promise<AffiliateWhitelistResponseSDKType> {
