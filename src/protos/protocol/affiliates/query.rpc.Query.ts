...
export interface Query {
  ...
  allAffiliateTiers(
    request?: AllAffiliateTiersRequest,
  ): Promise<AllAffiliateTiersResponse>;
  /** Query AffiliateWhitelist returns the affiliate whitelist. */

  affiliateWhitelist(
    request?: AffiliateWhitelistRequest,
  ): Promise<AffiliateWhitelistResponse>;
}
export class QueryClientImpl implements Query {
  ...
  affiliateInfo(request: AffiliateInfoRequest): Promise<AffiliateInfoResponse> {
    ...
    return promise.then((data) =>
      AffiliateInfoResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  referredBy(request: ReferredByRequest): Promise<ReferredByResponse> {
    ...
    return promise.then((data) =>
      ReferredByResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  allAffiliateTiers(
    ...
    return promise.then((data) =>
      AllAffiliateTiersResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  affiliateWhitelist(
    ...
    return promise.then((data) =>
      AffiliateWhitelistResponse.decode(new _m0.Reader(data)),
    );
  }
}
