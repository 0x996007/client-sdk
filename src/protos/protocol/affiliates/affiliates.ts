  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): AffiliateTiers {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.tiers.push(
            AffiliateTiers_Tier.decode(reader, reader.uint32()),
          );
          break;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): AffiliateWhitelist {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.tiers.push(
            AffiliateWhitelist_Tier.decode(reader, reader.uint32()),
          );
          break;
...
export const AffiliateWhitelist_Tier = {
  encode(
    message: AffiliateWhitelist_Tier,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
  ...
  fromPartial(
    object: DeepPartial<AffiliateWhitelist_Tier>,
  ): AffiliateWhitelist_Tier {
    const message = createBaseAffiliateWhitelist_Tier();
