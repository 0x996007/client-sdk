...
export interface Msg {
  ...
  registerAffiliate(
    request: MsgRegisterAffiliate,
  ): Promise<MsgRegisterAffiliateResponse>;
  /** UpdateAffiliateTiers updates affiliate tiers */

  updateAffiliateTiers(
    request: MsgUpdateAffiliateTiers,
  ): Promise<MsgUpdateAffiliateTiersResponse>;
  /** UpdateAffiliateWhitelist updates affiliate whitelist */

  updateAffiliateWhitelist(
    request: MsgUpdateAffiliateWhitelist,
  ): Promise<MsgUpdateAffiliateWhitelistResponse>;
}
export class MsgClientImpl implements Msg {
  ...
  registerAffiliate(
    ...
    return promise.then((data) =>
      MsgRegisterAffiliateResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  updateAffiliateTiers(
    ...
    return promise.then((data) =>
      MsgUpdateAffiliateTiersResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  updateAffiliateWhitelist(
    ...
    return promise.then((data) =>
      MsgUpdateAffiliateWhitelistResponse.decode(new _m0.Reader(data)),
    );
  }
}
