...
export const MsgRegisterAffiliateResponse = {
  encode(
    _: MsgRegisterAffiliateResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<MsgRegisterAffiliateResponse>,
  ): MsgRegisterAffiliateResponse {
    const message = createBaseMsgRegisterAffiliateResponse();
    return message;
  },
...
export const MsgUpdateAffiliateTiers = {
  ...
  fromPartial(
    object: DeepPartial<MsgUpdateAffiliateTiers>,
  ): MsgUpdateAffiliateTiers {
    const message = createBaseMsgUpdateAffiliateTiers();
...
export const MsgUpdateAffiliateTiersResponse = {
  ...
  fromPartial(
    _: DeepPartial<MsgUpdateAffiliateTiersResponse>,
  ): MsgUpdateAffiliateTiersResponse {
    const message = createBaseMsgUpdateAffiliateTiersResponse();
    return message;
  },
...
export const MsgUpdateAffiliateWhitelist = {
  ...
  fromPartial(
    object: DeepPartial<MsgUpdateAffiliateWhitelist>,
  ): MsgUpdateAffiliateWhitelist {
    const message = createBaseMsgUpdateAffiliateWhitelist();
    message.authority = object.authority ?? '';
    message.whitelist =
...
export const MsgUpdateAffiliateWhitelistResponse = {
  encode(
    _: MsgUpdateAffiliateWhitelistResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<MsgUpdateAffiliateWhitelistResponse>,
  ): MsgUpdateAffiliateWhitelistResponse {
    const message = createBaseMsgUpdateAffiliateWhitelistResponse();
    return message;
  },
