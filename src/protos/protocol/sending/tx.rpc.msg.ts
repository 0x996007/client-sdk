...
export interface Msg {
  ...
  createTransfer(
    request: MsgCreateTransfer,
  ): Promise<MsgCreateTransferResponse>;
  /**
  ...
  depositToSubaccount(
    request: MsgDepositToSubaccount,
  ): Promise<MsgDepositToSubaccountResponse>;
  /**
  ...
  withdrawFromSubaccount(
    request: MsgWithdrawFromSubaccount,
  ): Promise<MsgWithdrawFromSubaccountResponse>;
  /**
  ...
  sendFromModuleToAccount(
    request: MsgSendFromModuleToAccount,
  ): Promise<MsgSendFromModuleToAccountResponse>;
}
export class MsgClientImpl implements Msg {
  ...
  createTransfer(
    ...
    return promise.then((data) =>
      MsgCreateTransferResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  depositToSubaccount(
    ...
    return promise.then((data) =>
      MsgDepositToSubaccountResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  withdrawFromSubaccount(
    ...
    return promise.then((data) =>
      MsgWithdrawFromSubaccountResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  sendFromModuleToAccount(
    ...
    return promise.then((data) =>
      MsgSendFromModuleToAccountResponse.decode(new _m0.Reader(data)),
    );
  }
}
