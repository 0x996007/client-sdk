...
export const MsgCreateTransferResponse = {
  ...
  fromPartial(
    _: DeepPartial<MsgCreateTransferResponse>,
  ): MsgCreateTransferResponse {
    const message = createBaseMsgCreateTransferResponse();
    return message;
  },
...
export const MsgDepositToSubaccountResponse = {
  encode(
    _: MsgDepositToSubaccountResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<MsgDepositToSubaccountResponse>,
  ): MsgDepositToSubaccountResponse {
    const message = createBaseMsgDepositToSubaccountResponse();
    return message;
  },
...
export const MsgWithdrawFromSubaccountResponse = {
  encode(
    _: MsgWithdrawFromSubaccountResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<MsgWithdrawFromSubaccountResponse>,
  ): MsgWithdrawFromSubaccountResponse {
    const message = createBaseMsgWithdrawFromSubaccountResponse();
    return message;
  },
...
export const MsgSendFromModuleToAccountResponse = {
  encode(
    _: MsgSendFromModuleToAccountResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<MsgSendFromModuleToAccountResponse>,
  ): MsgSendFromModuleToAccountResponse {
    const message = createBaseMsgSendFromModuleToAccountResponse();
    return message;
  },
