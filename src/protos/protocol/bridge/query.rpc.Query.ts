...
export interface Query {
  ...
  eventParams(
    request?: QueryEventParamsRequest,
  ): Promise<QueryEventParamsResponse>;
  /** Queries the ProposeParams. */

  proposeParams(
    request?: QueryProposeParamsRequest,
  ): Promise<QueryProposeParamsResponse>;
  /** Queries the SafetyParams. */

  safetyParams(
    request?: QuerySafetyParamsRequest,
  ): Promise<QuerySafetyParamsResponse>;
  /**
  ...
  acknowledgedEventInfo(
    request?: QueryAcknowledgedEventInfoRequest,
  ): Promise<QueryAcknowledgedEventInfoResponse>;
  /**
  ...
  recognizedEventInfo(
    request?: QueryRecognizedEventInfoRequest,
  ): Promise<QueryRecognizedEventInfoResponse>;
  /**
  ...
  delayedCompleteBridgeMessages(
    request: QueryDelayedCompleteBridgeMessagesRequest,
  ): Promise<QueryDelayedCompleteBridgeMessagesResponse>;
}
export class QueryClientImpl implements Query {
  ...
  eventParams(
    ...
    return promise.then((data) =>
      QueryEventParamsResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  proposeParams(
    ...
    return promise.then((data) =>
      QueryProposeParamsResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  safetyParams(
    ...
    return promise.then((data) =>
      QuerySafetyParamsResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  acknowledgedEventInfo(
    ...
    return promise.then((data) =>
      QueryAcknowledgedEventInfoResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  recognizedEventInfo(
    ...
    return promise.then((data) =>
      QueryRecognizedEventInfoResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  delayedCompleteBridgeMessages(
    ...
    const data =
      QueryDelayedCompleteBridgeMessagesRequest.encode(request).finish();
    const promise = this.rpc.request(
      'dydxprotocol.bridge.Query',
      'DelayedCompleteBridgeMessages',
      data,
    ...
    return promise.then((data) =>
      QueryDelayedCompleteBridgeMessagesResponse.decode(new _m0.Reader(data)),
    );
  }
}
