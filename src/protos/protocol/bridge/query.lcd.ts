...
import {
  ...
  QueryEventParamsResponseSDKType,
  QueryProposeParamsRequest,
  QueryProposeParamsResponseSDKType,
  QuerySafetyParamsRequest,
  QuerySafetyParamsResponseSDKType,
  QueryAcknowledgedEventInfoRequest,
  QueryAcknowledgedEventInfoResponseSDKType,
  QueryRecognizedEventInfoRequest,
  QueryRecognizedEventInfoResponseSDKType,
  QueryDelayedCompleteBridgeMessagesRequest,
  QueryDelayedCompleteBridgeMessagesResponseSDKType,
} from './query.js';
export class LCDQueryClient {
  ...
  async eventParams(
    _params: QueryEventParamsRequest = {},
  ): Promise<QueryEventParamsResponseSDKType> {
  ...
  async proposeParams(
    _params: QueryProposeParamsRequest = {},
  ): Promise<QueryProposeParamsResponseSDKType> {
  ...
  async safetyParams(
    _params: QuerySafetyParamsRequest = {},
  ): Promise<QuerySafetyParamsResponseSDKType> {
  ...
  async acknowledgedEventInfo(
    _params: QueryAcknowledgedEventInfoRequest = {},
  ): Promise<QueryAcknowledgedEventInfoResponseSDKType> {
    const endpoint = `dydxprotocol/v4/bridge/acknowledged_event_info`;
    return await this.req.get<QueryAcknowledgedEventInfoResponseSDKType>(
      endpoint,
    );
  }
  ...
  async recognizedEventInfo(
    _params: QueryRecognizedEventInfoRequest = {},
  ): Promise<QueryRecognizedEventInfoResponseSDKType> {
    const endpoint = `dydxprotocol/v4/bridge/recognized_event_info`;
    return await this.req.get<QueryRecognizedEventInfoResponseSDKType>(
      endpoint,
    );
  }
  ...
  async delayedCompleteBridgeMessages(
    params: QueryDelayedCompleteBridgeMessagesRequest,
  ): Promise<QueryDelayedCompleteBridgeMessagesResponseSDKType> {
    const options: any = {
      params: {},
    };
    ...
    return await this.req.get<QueryDelayedCompleteBridgeMessagesResponseSDKType>(
      endpoint,
      options,
    );
  }
