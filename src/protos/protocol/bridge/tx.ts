...
import { BridgeEvent, BridgeEventSDKType } from './bridge_event.js';
import {
  EventParams,
  EventParamsSDKType,
  ProposeParams,
...
export const MsgAcknowledgeBridges = {
  ...
  fromPartial(
    object: DeepPartial<MsgAcknowledgeBridges>,
  ): MsgAcknowledgeBridges {
    const message = createBaseMsgAcknowledgeBridges();
    message.events =
...
export const MsgAcknowledgeBridgesResponse = {
  encode(
    _: MsgAcknowledgeBridgesResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<MsgAcknowledgeBridgesResponse>,
  ): MsgAcknowledgeBridgesResponse {
    const message = createBaseMsgAcknowledgeBridgesResponse();
    return message;
  },
...
export const MsgCompleteBridgeResponse = {
  ...
  fromPartial(
    _: DeepPartial<MsgCompleteBridgeResponse>,
  ): MsgCompleteBridgeResponse {
    const message = createBaseMsgCompleteBridgeResponse();
    return message;
  },
...
export const MsgUpdateEventParamsResponse = {
  encode(
    _: MsgUpdateEventParamsResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<MsgUpdateEventParamsResponse>,
  ): MsgUpdateEventParamsResponse {
    const message = createBaseMsgUpdateEventParamsResponse();
    return message;
  },
...
export const MsgUpdateProposeParams = {
  ...
  fromPartial(
    object: DeepPartial<MsgUpdateProposeParams>,
  ): MsgUpdateProposeParams {
    const message = createBaseMsgUpdateProposeParams();
    message.authority = object.authority ?? '';
    message.params =
...
export const MsgUpdateProposeParamsResponse = {
  encode(
    _: MsgUpdateProposeParamsResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<MsgUpdateProposeParamsResponse>,
  ): MsgUpdateProposeParamsResponse {
    const message = createBaseMsgUpdateProposeParamsResponse();
    return message;
  },
...
export const MsgUpdateSafetyParams = {
  ...
  fromPartial(
    object: DeepPartial<MsgUpdateSafetyParams>,
  ): MsgUpdateSafetyParams {
    const message = createBaseMsgUpdateSafetyParams();
    message.authority = object.authority ?? '';
    message.params =
...
export const MsgUpdateSafetyParamsResponse = {
  encode(
    _: MsgUpdateSafetyParamsResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<MsgUpdateSafetyParamsResponse>,
  ): MsgUpdateSafetyParamsResponse {
    const message = createBaseMsgUpdateSafetyParamsResponse();
    return message;
  },
