...
export interface Msg {
   ...
   */
  acknowledgeBridges(
    request: MsgAcknowledgeBridges,
  ): Promise<MsgAcknowledgeBridgesResponse>;
  /** CompleteBridge finalizes a bridge by minting coins to an address. */

  completeBridge(
    request: MsgCompleteBridge,
  ): Promise<MsgCompleteBridgeResponse>;
  /** UpdateEventParams updates the EventParams in state. */

  updateEventParams(
    request: MsgUpdateEventParams,
  ): Promise<MsgUpdateEventParamsResponse>;
  /** UpdateProposeParams updates the ProposeParams in state. */

  updateProposeParams(
    request: MsgUpdateProposeParams,
  ): Promise<MsgUpdateProposeParamsResponse>;
  /** UpdateSafetyParams updates the SafetyParams in state. */

  updateSafetyParams(
    request: MsgUpdateSafetyParams,
  ): Promise<MsgUpdateSafetyParamsResponse>;
}
export class MsgClientImpl implements Msg {
  ...
  acknowledgeBridges(
    ...
    const promise = this.rpc.request(
      'dydxprotocol.bridge.Msg',
      'AcknowledgeBridges',
      data,
    );
    return promise.then((data) =>
      MsgAcknowledgeBridgesResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  completeBridge(
    ...
    return promise.then((data) =>
      MsgCompleteBridgeResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  updateEventParams(
    ...
    return promise.then((data) =>
      MsgUpdateEventParamsResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  updateProposeParams(
    ...
    return promise.then((data) =>
      MsgUpdateProposeParamsResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  updateSafetyParams(
    ...
    return promise.then((data) =>
      MsgUpdateSafetyParamsResponse.decode(new _m0.Reader(data)),
    );
  }
}
