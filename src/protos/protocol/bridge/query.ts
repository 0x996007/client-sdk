...
import {
  ...
  EventParamsSDKType,
  ProposeParams,
  ProposeParamsSDKType,
  SafetyParams,
  SafetyParamsSDKType,
} from './params.js';
import {
  BridgeEventInfo,
  BridgeEventInfoSDKType,
} from './bridge_event_info.js';
import { MsgCompleteBridge, MsgCompleteBridgeSDKType } from './tx.js';
...
export const QueryEventParamsRequest = {
  ...
  fromPartial(
    _: DeepPartial<QueryEventParamsRequest>,
  ): QueryEventParamsRequest {
    const message = createBaseQueryEventParamsRequest();
    return message;
  },
...
export const QueryEventParamsResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryEventParamsResponse>,
  ): QueryEventParamsResponse {
    const message = createBaseQueryEventParamsResponse();
    message.params =
...
export const QueryProposeParamsRequest = {
  ...
  fromPartial(
    _: DeepPartial<QueryProposeParamsRequest>,
  ): QueryProposeParamsRequest {
    const message = createBaseQueryProposeParamsRequest();
    return message;
  },
...
export const QueryProposeParamsResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryProposeParamsResponse>,
  ): QueryProposeParamsResponse {
    const message = createBaseQueryProposeParamsResponse();
    message.params =
      object.params !== undefined && object.params !== null
...
export const QuerySafetyParamsRequest = {
  ...
  fromPartial(
    _: DeepPartial<QuerySafetyParamsRequest>,
  ): QuerySafetyParamsRequest {
    const message = createBaseQuerySafetyParamsRequest();
    return message;
  },
...
export const QuerySafetyParamsResponse = {
  ...
  fromPartial(
    object: DeepPartial<QuerySafetyParamsResponse>,
  ): QuerySafetyParamsResponse {
    const message = createBaseQuerySafetyParamsResponse();
    message.params =
      object.params !== undefined && object.params !== null
...
export const QueryAcknowledgedEventInfoRequest = {
  encode(
    _: QueryAcknowledgedEventInfoRequest,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<QueryAcknowledgedEventInfoRequest>,
  ): QueryAcknowledgedEventInfoRequest {
    const message = createBaseQueryAcknowledgedEventInfoRequest();
    return message;
  },
...
export const QueryAcknowledgedEventInfoResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryAcknowledgedEventInfoResponse>,
  ): QueryAcknowledgedEventInfoResponse {
    const message = createBaseQueryAcknowledgedEventInfoResponse();
    message.info =
...
export const QueryRecognizedEventInfoRequest = {
  encode(
    _: QueryRecognizedEventInfoRequest,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<QueryRecognizedEventInfoRequest>,
  ): QueryRecognizedEventInfoRequest {
    const message = createBaseQueryRecognizedEventInfoRequest();
    return message;
  },
...
export const QueryRecognizedEventInfoResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryRecognizedEventInfoResponse>,
  ): QueryRecognizedEventInfoResponse {
    const message = createBaseQueryRecognizedEventInfoResponse();
    message.info =
      object.info !== undefined && object.info !== null
...
export const QueryDelayedCompleteBridgeMessagesRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryDelayedCompleteBridgeMessagesRequest>,
  ): QueryDelayedCompleteBridgeMessagesRequest {
    const message = createBaseQueryDelayedCompleteBridgeMessagesRequest();
...
export const QueryDelayedCompleteBridgeMessagesResponse = {
  encode(
    ...
    for (const v of message.messages) {
      DelayedCompleteBridgeMessage.encode(
        v!,
      ...
      switch (tag >>> 3) {
        case 1:
          message.messages.push(
            DelayedCompleteBridgeMessage.decode(reader, reader.uint32()),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<QueryDelayedCompleteBridgeMessagesResponse>,
  ): QueryDelayedCompleteBridgeMessagesResponse {
    const message = createBaseQueryDelayedCompleteBridgeMessagesResponse();
    message.messages =
      object.messages?.map((e) =>
        DelayedCompleteBridgeMessage.fromPartial(e),
      ) || [];
    return message;
  },
};
...
export const DelayedCompleteBridgeMessage = {
  ...
  fromPartial(
    object: DeepPartial<DelayedCompleteBridgeMessage>,
  ): DelayedCompleteBridgeMessage {
    const message = createBaseDelayedCompleteBridgeMessage();
    message.message =
