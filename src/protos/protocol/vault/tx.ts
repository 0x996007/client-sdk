...
import { NumShares, NumSharesSDKType } from './share.js';
import {
  QuotingParams,
...
import { VaultId, VaultIdSDKType } from './vault.js';
...
export const MsgDepositToMegavault = {
  ...
  fromPartial(
    object: DeepPartial<MsgDepositToMegavault>,
  ): MsgDepositToMegavault {
    const message = createBaseMsgDepositToMegavault();
    message.subaccountId =
...
export const MsgDepositToMegavaultResponse = {
  ...
  fromPartial(
    object: DeepPartial<MsgDepositToMegavaultResponse>,
  ): MsgDepositToMegavaultResponse {
    const message = createBaseMsgDepositToMegavaultResponse();
...
export const MsgWithdrawFromMegavault = {
  ...
  fromPartial(
    object: DeepPartial<MsgWithdrawFromMegavault>,
  ): MsgWithdrawFromMegavault {
    const message = createBaseMsgWithdrawFromMegavault();
    message.subaccountId =
      object.subaccountId !== undefined && object.subaccountId !== null
...
export const MsgWithdrawFromMegavaultResponse = {
  ...
  fromPartial(
    object: DeepPartial<MsgWithdrawFromMegavaultResponse>,
  ): MsgWithdrawFromMegavaultResponse {
    const message = createBaseMsgWithdrawFromMegavaultResponse();
    message.quoteQuantums = object.quoteQuantums ?? new Uint8Array();
    return message;
...
export const MsgUpdateDefaultQuotingParams = {
  ...
  fromPartial(
    object: DeepPartial<MsgUpdateDefaultQuotingParams>,
  ): MsgUpdateDefaultQuotingParams {
    const message = createBaseMsgUpdateDefaultQuotingParams();
...
export const MsgUpdateDefaultQuotingParamsResponse = {
  encode(
    _: MsgUpdateDefaultQuotingParamsResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
...
export const MsgSetVaultParamsResponse = {
  ...
  fromPartial(
    _: DeepPartial<MsgSetVaultParamsResponse>,
  ): MsgSetVaultParamsResponse {
    const message = createBaseMsgSetVaultParamsResponse();
    return message;
  },
...
export const MsgUnlockSharesResponse = {
  ...
  fromPartial(
    object: DeepPartial<MsgUnlockSharesResponse>,
  ): MsgUnlockSharesResponse {
    const message = createBaseMsgUnlockSharesResponse();
    message.unlockedShares =
...
export const MsgUpdateOperatorParams = {
  ...
  fromPartial(
    object: DeepPartial<MsgUpdateOperatorParams>,
  ): MsgUpdateOperatorParams {
    const message = createBaseMsgUpdateOperatorParams();
    message.authority = object.authority ?? '';
    message.params =
...
export const MsgUpdateOperatorParamsResponse = {
  encode(
    _: MsgUpdateOperatorParamsResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<MsgUpdateOperatorParamsResponse>,
  ): MsgUpdateOperatorParamsResponse {
    const message = createBaseMsgUpdateOperatorParamsResponse();
    return message;
  },
...
export const MsgAllocateToVaultResponse = {
  ...
  fromPartial(
    _: DeepPartial<MsgAllocateToVaultResponse>,
  ): MsgAllocateToVaultResponse {
    const message = createBaseMsgAllocateToVaultResponse();
    return message;
  },
...
export const MsgRetrieveFromVaultResponse = {
  encode(
    _: MsgRetrieveFromVaultResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<MsgRetrieveFromVaultResponse>,
  ): MsgRetrieveFromVaultResponse {
    const message = createBaseMsgRetrieveFromVaultResponse();
    return message;
  },
...
export const MsgSetVaultQuotingParams = {
  ...
  fromPartial(
    object: DeepPartial<MsgSetVaultQuotingParams>,
  ): MsgSetVaultQuotingParams {
    const message = createBaseMsgSetVaultQuotingParams();
    message.authority = object.authority ?? '';
    message.vaultId =
