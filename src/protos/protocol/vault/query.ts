...
import { VaultType, VaultId, VaultIdSDKType } from './vault.js';
import {
  PageRequest,
  PageRequestSDKType,
  PageResponse,
...
import {
  QuotingParams,
  QuotingParamsSDKType,
  OperatorParams,
  OperatorParamsSDKType,
  VaultParams,
  VaultParamsSDKType,
} from './params.js';
import {
...
export const QueryParamsResponse = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryParamsResponse {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.defaultQuotingParams = QuotingParams.decode(
            reader,
            reader.uint32(),
          );
          break;
        ...
        case 2:
          message.operatorParams = OperatorParams.decode(
            reader,
            reader.uint32(),
          );
          break;
...
export const QueryAllVaultsRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryAllVaultsRequest>,
  ): QueryAllVaultsRequest {
    const message = createBaseQueryAllVaultsRequest();
    message.pagination =
...
export const QueryAllVaultsResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryAllVaultsResponse>,
  ): QueryAllVaultsResponse {
    const message = createBaseQueryAllVaultsResponse();
    message.vaults =
...
export const QueryMegavaultTotalSharesRequest = {
  encode(
    _: QueryMegavaultTotalSharesRequest,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<QueryMegavaultTotalSharesRequest>,
  ): QueryMegavaultTotalSharesRequest {
    const message = createBaseQueryMegavaultTotalSharesRequest();
    return message;
  },
...
export const QueryMegavaultTotalSharesResponse = {
  encode(
    message: QueryMegavaultTotalSharesResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
  ...
  fromPartial(
    object: DeepPartial<QueryMegavaultTotalSharesResponse>,
  ): QueryMegavaultTotalSharesResponse {
    const message = createBaseQueryMegavaultTotalSharesResponse();
    message.totalShares =
...
export const QueryMegavaultOwnerSharesRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryMegavaultOwnerSharesRequest>,
  ): QueryMegavaultOwnerSharesRequest {
    const message = createBaseQueryMegavaultOwnerSharesRequest();
...
export const QueryMegavaultOwnerSharesResponse = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          message.shareUnlocks.push(
            ShareUnlock.decode(reader, reader.uint32()),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<QueryMegavaultOwnerSharesResponse>,
  ): QueryMegavaultOwnerSharesResponse {
    const message = createBaseQueryMegavaultOwnerSharesResponse();
    message.address = object.address ?? '';
    message.shares =
...
export const QueryMegavaultAllOwnerSharesRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryMegavaultAllOwnerSharesRequest>,
  ): QueryMegavaultAllOwnerSharesRequest {
    const message = createBaseQueryMegavaultAllOwnerSharesRequest();
    message.pagination =
      object.pagination !== undefined && object.pagination !== null
...
export const QueryMegavaultAllOwnerSharesResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryMegavaultAllOwnerSharesResponse>,
  ): QueryMegavaultAllOwnerSharesResponse {
    const message = createBaseQueryMegavaultAllOwnerSharesResponse();
    message.ownerShares =
...
export const QueryVaultParamsRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryVaultParamsRequest>,
  ): QueryVaultParamsRequest {
    const message = createBaseQueryVaultParamsRequest();
    message.type = object.type ?? 0;
    message.number = object.number ?? 0;
...
export const QueryVaultParamsResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryVaultParamsResponse>,
  ): QueryVaultParamsResponse {
    const message = createBaseQueryVaultParamsResponse();
    message.vaultId =
      object.vaultId !== undefined && object.vaultId !== null
...
export const QueryMegavaultWithdrawalInfoRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryMegavaultWithdrawalInfoRequest>,
  ): QueryMegavaultWithdrawalInfoRequest {
    const message = createBaseQueryMegavaultWithdrawalInfoRequest();
    message.sharesToWithdraw =
...
export const QueryMegavaultWithdrawalInfoResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryMegavaultWithdrawalInfoResponse>,
  ): QueryMegavaultWithdrawalInfoResponse {
    const message = createBaseQueryMegavaultWithdrawalInfoResponse();
    message.sharesToWithdraw =
      object.sharesToWithdraw !== undefined && object.sharesToWithdraw !== null
