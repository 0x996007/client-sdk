...
export interface Msg {
  ...
  depositToMegavault(
    request: MsgDepositToMegavault,
  ): Promise<MsgDepositToMegavaultResponse>;
  /** WithdrawFromMegavault withdraws shares from megavault. */

  withdrawFromMegavault(
    request: MsgWithdrawFromMegavault,
  ): Promise<MsgWithdrawFromMegavaultResponse>;
  /** UpdateDefaultQuotingParams updates the default quoting params in state. */

  updateDefaultQuotingParams(
    request: MsgUpdateDefaultQuotingParams,
  ): Promise<MsgUpdateDefaultQuotingParamsResponse>;
  /** UpdateOperatorParams sets the parameters regarding megavault operator. */

  updateOperatorParams(
    request: MsgUpdateOperatorParams,
  ): Promise<MsgUpdateOperatorParamsResponse>;
  /** SetVaultParams sets the parameters of a specific vault. */

  setVaultParams(
    request: MsgSetVaultParams,
  ): Promise<MsgSetVaultParamsResponse>;
  /**
  ...
  allocateToVault(
    request: MsgAllocateToVault,
  ): Promise<MsgAllocateToVaultResponse>;
  /** RetrieveFromVault retrieves funds from a vault to main vault. */

  retrieveFromVault(
    request: MsgRetrieveFromVault,
  ): Promise<MsgRetrieveFromVaultResponse>;
}
export class MsgClientImpl implements Msg {
  ...
  depositToMegavault(
    ...
    return promise.then((data) =>
      MsgDepositToMegavaultResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  withdrawFromMegavault(
    ...
    return promise.then((data) =>
      MsgWithdrawFromMegavaultResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  updateDefaultQuotingParams(
    ...
    return promise.then((data) =>
      MsgUpdateDefaultQuotingParamsResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  updateOperatorParams(
    ...
    return promise.then((data) =>
      MsgUpdateOperatorParamsResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  setVaultParams(
    ...
    return promise.then((data) =>
      MsgSetVaultParamsResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  unlockShares(request: MsgUnlockShares): Promise<MsgUnlockSharesResponse> {
    ...
    return promise.then((data) =>
      MsgUnlockSharesResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  allocateToVault(
    ...
    return promise.then((data) =>
      MsgAllocateToVaultResponse.decode(new _m0.Reader(data)),
    );
  }
