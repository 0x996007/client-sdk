...
export class QueryClientImpl implements Query {
  ...
  megavaultTotalShares(
    ...
    return promise.then((data) =>
      QueryMegavaultTotalSharesResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  megavaultOwnerShares(
    ...
    return promise.then((data) =>
      QueryMegavaultOwnerSharesResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  megavaultAllOwnerShares(
    ...
    return promise.then((data) =>
      QueryMegavaultAllOwnerSharesResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  vaultParams(
    ...
    return promise.then((data) =>
      QueryVaultParamsResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  megavaultWithdrawalInfo(
    ...
    return promise.then((data) =>
      QueryMegavaultWithdrawalInfoResponse.decode(new _m0.Reader(data)),
    );
  }
}
