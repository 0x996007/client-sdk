...
import {
  ...
  QueryVaultRequest,
  QueryVaultResponseSDKType,
  QueryAllVaultsRequest,
  QueryAllVaultsResponseSDKType,
  QueryMegavaultTotalSharesRequest,
  QueryMegavaultTotalSharesResponseSDKType,
  QueryMegavaultOwnerSharesRequest,
  QueryMegavaultOwnerSharesResponseSDKType,
  QueryMegavaultAllOwnerSharesRequest,
  QueryMegavaultAllOwnerSharesResponseSDKType,
  QueryVaultParamsRequest,
  QueryVaultParamsResponseSDKType,
} from './query.js';
export class LCDQueryClient {
  ...
  async megavaultTotalShares(
    _params: QueryMegavaultTotalSharesRequest = {},
  ): Promise<QueryMegavaultTotalSharesResponseSDKType> {
    const endpoint = `dydxprotocol/vault/megavault/total_shares`;
    return await this.req.get<QueryMegavaultTotalSharesResponseSDKType>(
      endpoint,
    );
  }
  ...
  async megavaultOwnerShares(
    ...
    return await this.req.get<QueryMegavaultOwnerSharesResponseSDKType>(
      endpoint,
    );
  }
  /* Queries all owner shares of megavault. */

  async megavaultAllOwnerShares(
    params: QueryMegavaultAllOwnerSharesRequest = {
      pagination: undefined,
    },
    ...
    return await this.req.get<QueryMegavaultAllOwnerSharesResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async vaultParams(
    params: QueryVaultParamsRequest,
  ): Promise<QueryVaultParamsResponseSDKType> {
