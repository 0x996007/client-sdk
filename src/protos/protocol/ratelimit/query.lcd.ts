...
import {
  ...
  ListLimitParamsResponseSDKType,
  QueryCapacityByDenomRequest,
  QueryCapacityByDenomResponseSDKType,
  QueryAllPendingSendPacketsRequest,
  QueryAllPendingSendPacketsResponseSDKType,
} from './query.js';
export class LCDQueryClient {
  ...
  async listLimitParams(
    _params: ListLimitParamsRequest = {},
  ): Promise<ListLimitParamsResponseSDKType> {
  ...
  async capacityByDenom(
    params: QueryCapacityByDenomRequest,
  ): Promise<QueryCapacityByDenomResponseSDKType> {
    const options: any = {
      params: {},
    };
    ...
    return await this.req.get<QueryCapacityByDenomResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async allPendingSendPackets(
    _params: QueryAllPendingSendPacketsRequest = {},
  ): Promise<QueryAllPendingSendPacketsResponseSDKType> {
    const endpoint = `dydxprotocol/v4/ratelimit/get_all_pending_send_packet`;
    return await this.req.get<QueryAllPendingSendPacketsResponseSDKType>(
      endpoint,
    );
  }
}
