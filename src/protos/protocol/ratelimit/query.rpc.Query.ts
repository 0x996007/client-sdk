...
export interface Query {
  ...
  listLimitParams(
    request?: ListLimitParamsRequest,
  ): Promise<ListLimitParamsResponse>;
  /** Query capacity by denom. */

  capacityByDenom(
    request: QueryCapacityByDenomRequest,
  ): Promise<QueryCapacityByDenomResponse>;
  /** Get all pending send packets */

  allPendingSendPackets(
    request?: QueryAllPendingSendPacketsRequest,
  ): Promise<QueryAllPendingSendPacketsResponse>;
}
export class QueryClientImpl implements Query {
  ...
  listLimitParams(
    ...
    return promise.then((data) =>
      ListLimitParamsResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  capacityByDenom(
    ...
    return promise.then((data) =>
      QueryCapacityByDenomResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  allPendingSendPackets(
    ...
    return promise.then((data) =>
      QueryAllPendingSendPacketsResponse.decode(new _m0.Reader(data)),
    );
  }
}
