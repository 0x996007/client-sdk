...
import { LimitParams, LimitParamsSDKType } from './limit_params.js';
import { LimiterCapacity, LimiterCapacitySDKType } from './capacity.js';
import {
  PendingSendPacket,
  PendingSendPacketSDKType,
} from './pending_send_packet.js';
...
export const ListLimitParamsResponse = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.limitParamsList.push(
            LimitParams.decode(reader, reader.uint32()),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<ListLimitParamsResponse>,
  ): ListLimitParamsResponse {
    const message = createBaseListLimitParamsResponse();
...
export const QueryCapacityByDenomRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryCapacityByDenomRequest>,
  ): QueryCapacityByDenomRequest {
    const message = createBaseQueryCapacityByDenomRequest();
...
export const QueryCapacityByDenomResponse = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.limiterCapacityList.push(
            LimiterCapacity.decode(reader, reader.uint32()),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<QueryCapacityByDenomResponse>,
  ): QueryCapacityByDenomResponse {
    const message = createBaseQueryCapacityByDenomResponse();
...
export const QueryAllPendingSendPacketsRequest = {
  encode(
    _: QueryAllPendingSendPacketsRequest,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<QueryAllPendingSendPacketsRequest>,
  ): QueryAllPendingSendPacketsRequest {
    const message = createBaseQueryAllPendingSendPacketsRequest();
    return message;
  },
...
export const QueryAllPendingSendPacketsResponse = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.pendingSendPackets.push(
            PendingSendPacket.decode(reader, reader.uint32()),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<QueryAllPendingSendPacketsResponse>,
  ): QueryAllPendingSendPacketsResponse {
    const message = createBaseQueryAllPendingSendPacketsResponse();
