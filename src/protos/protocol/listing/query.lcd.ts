...
import {
  QueryMarketsHardCap,
  QueryMarketsHardCapResponseSDKType,
  QueryListingVaultDepositParams,
  QueryListingVaultDepositParamsResponseSDKType,
} from './query.js';
export class LCDQueryClient {
  ...
  async marketsHardCap(
    _params: QueryMarketsHardCap = {},
  ): Promise<QueryMarketsHardCapResponseSDKType> {
  ...
  async listingVaultDepositParams(
    _params: QueryListingVaultDepositParams = {},
  ): Promise<QueryListingVaultDepositParamsResponseSDKType> {
    const endpoint = `dydxprotocol/listing/vault_deposit_params`;
    return await this.req.get<QueryListingVaultDepositParamsResponseSDKType>(
      endpoint,
    );
  }
}
