...
export interface Msg {
  ...
  setMarketsHardCap(
    request: MsgSetMarketsHardCap,
  ): Promise<MsgSetMarketsHardCapResponse>;
  ...
  ): Promise<MsgCreateMarketPermissionlessResponse>;
  /** SetListingVaultDepositParams sets PML megavault deposit params */

  setListingVaultDepositParams(
    request: MsgSetListingVaultDepositParams,
  ): Promise<MsgSetListingVaultDepositParamsResponse>;
  /**
  ...
  upgradeIsolatedPerpetualToCross(
    request: MsgUpgradeIsolatedPerpetualToCross,
  ): Promise<MsgUpgradeIsolatedPerpetualToCrossResponse>;
}
export class MsgClientImpl implements Msg {
  ...
  setMarketsHardCap(
    ...
    return promise.then((data) =>
      MsgSetMarketsHardCapResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  createMarketPermissionless(
    ...
    return promise.then((data) =>
      MsgCreateMarketPermissionlessResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  setListingVaultDepositParams(
    ...
    return promise.then((data) =>
      MsgSetListingVaultDepositParamsResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  upgradeIsolatedPerpetualToCross(
    ...
    return promise.then((data) =>
      MsgUpgradeIsolatedPerpetualToCrossResponse.decode(new _m0.Reader(data)),
    );
  }
}
