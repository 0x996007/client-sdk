...
export const QueryMarketsHardCapResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryMarketsHardCapResponse>,
  ): QueryMarketsHardCapResponse {
    const message = createBaseQueryMarketsHardCapResponse();
...
export const QueryListingVaultDepositParams = {
  encode(
    _: QueryListingVaultDepositParams,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<QueryListingVaultDepositParams>,
  ): QueryListingVaultDepositParams {
    const message = createBaseQueryListingVaultDepositParams();
    return message;
  },
...
export const QueryListingVaultDepositParamsResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryListingVaultDepositParamsResponse>,
  ): QueryListingVaultDepositParamsResponse {
    const message = createBaseQueryListingVaultDepositParamsResponse();
    message.params =
