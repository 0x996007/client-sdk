...
export interface Query {
  ...
  marketsHardCap(
    request?: QueryMarketsHardCap,
  ): Promise<QueryMarketsHardCapResponse>;
  /** Queries the listing vault deposit params */

  listingVaultDepositParams(
    request?: QueryListingVaultDepositParams,
  ): Promise<QueryListingVaultDepositParamsResponse>;
}
export class QueryClientImpl implements Query {
  ...
  marketsHardCap(
    ...
    return promise.then((data) =>
      QueryMarketsHardCapResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  listingVaultDepositParams(
    ...
    return promise.then((data) =>
      QueryListingVaultDepositParamsResponse.decode(new _m0.Reader(data)),
    );
  }
}
