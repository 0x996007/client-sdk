...
import {
  ...
  ListingVaultDepositParamsSDKType,
} from './params.js';
...
export const MsgSetMarketsHardCapResponse = {
  encode(
    _: MsgSetMarketsHardCapResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<MsgSetMarketsHardCapResponse>,
  ): MsgSetMarketsHardCapResponse {
    const message = createBaseMsgSetMarketsHardCapResponse();
    return message;
  },
...
export const MsgCreateMarketPermissionless = {
  ...
  fromPartial(
    object: DeepPartial<MsgCreateMarketPermissionless>,
  ): MsgCreateMarketPermissionless {
    const message = createBaseMsgCreateMarketPermissionless();
...
export const MsgCreateMarketPermissionlessResponse = {
  encode(
    _: MsgCreateMarketPermissionlessResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<MsgCreateMarketPermissionlessResponse>,
  ): MsgCreateMarketPermissionlessResponse {
    const message = createBaseMsgCreateMarketPermissionlessResponse();
    return message;
  },
...
export const MsgSetListingVaultDepositParams = {
  encode(
    ...
    if (message.params !== undefined) {
      ListingVaultDepositParams.encode(
        message.params,
        writer.uint32(18).fork(),
      ).ldelim();
    }
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          message.params = ListingVaultDepositParams.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<MsgSetListingVaultDepositParams>,
  ): MsgSetListingVaultDepositParams {
    const message = createBaseMsgSetListingVaultDepositParams();
    message.authority = object.authority ?? '';
    message.params =
...
export const MsgSetListingVaultDepositParamsResponse = {
  encode(
    _: MsgSetListingVaultDepositParamsResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<MsgSetListingVaultDepositParamsResponse>,
  ): MsgSetListingVaultDepositParamsResponse {
    const message = createBaseMsgSetListingVaultDepositParamsResponse();
    return message;
  },
...
export const MsgUpgradeIsolatedPerpetualToCross = {
  ...
  fromPartial(
    object: DeepPartial<MsgUpgradeIsolatedPerpetualToCross>,
  ): MsgUpgradeIsolatedPerpetualToCross {
    const message = createBaseMsgUpgradeIsolatedPerpetualToCross();
    message.authority = object.authority ?? '';
...
export const MsgUpgradeIsolatedPerpetualToCrossResponse = {
  encode(
    _: MsgUpgradeIsolatedPerpetualToCrossResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<MsgUpgradeIsolatedPerpetualToCrossResponse>,
  ): MsgUpgradeIsolatedPerpetualToCrossResponse {
    const message = createBaseMsgUpgradeIsolatedPerpetualToCrossResponse();
    return message;
  },
