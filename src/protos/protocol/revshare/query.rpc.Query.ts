...
export interface Query {
  ...
  ): Promise<QueryMarketMapperRevenueShareParamsResponse>;
  /** Queries market mapper revenue share details for a specific market */

  marketMapperRevShareDetails(
    request: QueryMarketMapperRevShareDetails,
  ): Promise<QueryMarketMapperRevShareDetailsResponse>;
  /** Queries unconditional revenue share config */

  unconditionalRevShareConfig(
    request?: QueryUnconditionalRevShareConfig,
  ): Promise<QueryUnconditionalRevShareConfigResponse>;
}
export class QueryClientImpl implements Query {
  ...
  marketMapperRevenueShareParams(
    ...
    return promise.then((data) =>
      QueryMarketMapperRevenueShareParamsResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  marketMapperRevShareDetails(
    ...
    return promise.then((data) =>
      QueryMarketMapperRevShareDetailsResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  unconditionalRevShareConfig(
    ...
    return promise.then((data) =>
      QueryUnconditionalRevShareConfigResponse.decode(new _m0.Reader(data)),
    );
  }
}
