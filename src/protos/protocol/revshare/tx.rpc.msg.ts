...
export interface Msg {
  ...
  setMarketMapperRevenueShare(
    request: MsgSetMarketMapperRevenueShare,
  ): Promise<MsgSetMarketMapperRevenueShareResponse>;
  /**
  ...
  ): Promise<MsgSetMarketMapperRevShareDetailsForMarketResponse>;
  ...
  ): Promise<MsgUpdateUnconditionalRevShareConfigResponse>;
}
export class MsgClientImpl implements Msg {
  ...
  setMarketMapperRevenueShare(
    ...
    return promise.then((data) =>
      MsgSetMarketMapperRevenueShareResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  setMarketMapperRevShareDetailsForMarket(
    ...
    const data =
      MsgSetMarketMapperRevShareDetailsForMarket.encode(request).finish();
    const promise = this.rpc.request(
      'dydxprotocol.revshare.Msg',
      'SetMarketMapperRevShareDetailsForMarket',
      data,
    ...
    return promise.then((data) =>
      MsgSetMarketMapperRevShareDetailsForMarketResponse.decode(
        new _m0.Reader(data),
      ),
    );
  }
  ...
  updateUnconditionalRevShareConfig(
    ...
    return promise.then((data) =>
      MsgUpdateUnconditionalRevShareConfigResponse.decode(new _m0.Reader(data)),
    );
  }
}
