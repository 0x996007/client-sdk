...
import {
  ...
  MarketMapperRevenueShareParamsSDKType,
} from './params.js';
import {
  MarketMapperRevShareDetails,
  MarketMapperRevShareDetailsSDKType,
...
export const MsgSetMarketMapperRevenueShare = {
  encode(
    ...
    if (message.params !== undefined) {
      MarketMapperRevenueShareParams.encode(
        message.params,
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          message.params = MarketMapperRevenueShareParams.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<MsgSetMarketMapperRevenueShare>,
  ): MsgSetMarketMapperRevenueShare {
    const message = createBaseMsgSetMarketMapperRevenueShare();
...
export const MsgSetMarketMapperRevenueShareResponse = {
  encode(
    _: MsgSetMarketMapperRevenueShareResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<MsgSetMarketMapperRevenueShareResponse>,
  ): MsgSetMarketMapperRevenueShareResponse {
    const message = createBaseMsgSetMarketMapperRevenueShareResponse();
    return message;
  },
...
export const MsgSetMarketMapperRevShareDetailsForMarket = {
  encode(
    ...
    if (message.params !== undefined) {
      MarketMapperRevShareDetails.encode(
        message.params,
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          message.params = MarketMapperRevShareDetails.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<MsgSetMarketMapperRevShareDetailsForMarket>,
  ): MsgSetMarketMapperRevShareDetailsForMarket {
    const message = createBaseMsgSetMarketMapperRevShareDetailsForMarket();
    message.authority = object.authority ?? '';
...
export const MsgSetMarketMapperRevShareDetailsForMarketResponse = {
  ...
  decode(
    ...
    const end = length === undefined ? reader.len : reader.pos + length;
    const message =
      createBaseMsgSetMarketMapperRevShareDetailsForMarketResponse();
  ...
  fromPartial(
    _: DeepPartial<MsgSetMarketMapperRevShareDetailsForMarketResponse>,
  ): MsgSetMarketMapperRevShareDetailsForMarketResponse {
    const message =
      createBaseMsgSetMarketMapperRevShareDetailsForMarketResponse();
    return message;
...
export const MsgUpdateUnconditionalRevShareConfig = {
  encode(
    ...
    if (message.config !== undefined) {
      UnconditionalRevShareConfig.encode(
        message.config,
        writer.uint32(18).fork(),
      ).ldelim();
    }
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          message.config = UnconditionalRevShareConfig.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<MsgUpdateUnconditionalRevShareConfig>,
  ): MsgUpdateUnconditionalRevShareConfig {
    const message = createBaseMsgUpdateUnconditionalRevShareConfig();
    message.authority = object.authority ?? '';
    message.config =
...
export const MsgUpdateUnconditionalRevShareConfigResponse = {
  encode(
    _: MsgUpdateUnconditionalRevShareConfigResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<MsgUpdateUnconditionalRevShareConfigResponse>,
  ): MsgUpdateUnconditionalRevShareConfigResponse {
    const message = createBaseMsgUpdateUnconditionalRevShareConfigResponse();
    return message;
  },
