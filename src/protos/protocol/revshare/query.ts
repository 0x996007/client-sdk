...
export const QueryMarketMapperRevenueShareParams = {
  encode(
    _: QueryMarketMapperRevenueShareParams,
  ...
  fromPartial(
    _: DeepPartial<QueryMarketMapperRevenueShareParams>,
  ): QueryMarketMapperRevenueShareParams {
    const message = createBaseQueryMarketMapperRevenueShareParams();
    return message;
  },
...
export const QueryMarketMapperRevenueShareParamsResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryMarketMapperRevenueShareParamsResponse>,
  ): QueryMarketMapperRevenueShareParamsResponse {
    const message = createBaseQueryMarketMapperRevenueShareParamsResponse();
    message.params =
...
export const QueryMarketMapperRevShareDetails = {
  ...
  fromPartial(
    object: DeepPartial<QueryMarketMapperRevShareDetails>,
  ): QueryMarketMapperRevShareDetails {
    const message = createBaseQueryMarketMapperRevShareDetails();
...
export const QueryMarketMapperRevShareDetailsResponse = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.details = MarketMapperRevShareDetails.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<QueryMarketMapperRevShareDetailsResponse>,
  ): QueryMarketMapperRevShareDetailsResponse {
    const message = createBaseQueryMarketMapperRevShareDetailsResponse();
    message.details =
...
export const QueryUnconditionalRevShareConfig = {
  encode(
    _: QueryUnconditionalRevShareConfig,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<QueryUnconditionalRevShareConfig>,
  ): QueryUnconditionalRevShareConfig {
    const message = createBaseQueryUnconditionalRevShareConfig();
    return message;
  },
...
export const QueryUnconditionalRevShareConfigResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryUnconditionalRevShareConfigResponse>,
  ): QueryUnconditionalRevShareConfigResponse {
    const message = createBaseQueryUnconditionalRevShareConfigResponse();
    message.config =
