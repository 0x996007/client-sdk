...
export const MarketMapperRevShareDetails = {
  ...
  fromPartial(
    object: DeepPartial<MarketMapperRevShareDetails>,
  ): MarketMapperRevShareDetails {
    const message = createBaseMarketMapperRevShareDetails();
...
export const UnconditionalRevShareConfig = {
  encode(
    ...
    for (const v of message.configs) {
      UnconditionalRevShareConfig_RecipientConfig.encode(
        v!,
      ...
      switch (tag >>> 3) {
        case 1:
          message.configs.push(
            UnconditionalRevShareConfig_RecipientConfig.decode(
              reader,
              reader.uint32(),
            ),
          );
  ...
  fromPartial(
    object: DeepPartial<UnconditionalRevShareConfig>,
  ): UnconditionalRevShareConfig {
    const message = createBaseUnconditionalRevShareConfig();
    message.configs =
      object.configs?.map((e) =>
        UnconditionalRevShareConfig_RecipientConfig.fromPartial(e),
      ) || [];
    return message;
  },
};
...
export const UnconditionalRevShareConfig_RecipientConfig = {
  encode(
    message: UnconditionalRevShareConfig_RecipientConfig,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    if (message.address !== '') {
  ...
  fromPartial(
    object: DeepPartial<UnconditionalRevShareConfig_RecipientConfig>,
  ): UnconditionalRevShareConfig_RecipientConfig {
    const message = createBaseUnconditionalRevShareConfig_RecipientConfig();
