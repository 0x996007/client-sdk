...
export const MsgCreatePerpetualResponse = {
  ...
  fromPartial(
    _: DeepPartial<MsgCreatePerpetualResponse>,
  ): MsgCreatePerpetualResponse {
    const message = createBaseMsgCreatePerpetualResponse();
    return message;
  },
...
export const MsgSetLiquidityTierResponse = {
  ...
  fromPartial(
    _: DeepPartial<MsgSetLiquidityTierResponse>,
  ): MsgSetLiquidityTierResponse {
    const message = createBaseMsgSetLiquidityTierResponse();
    return message;
  },
...
export const MsgUpdatePerpetualParams = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          message.perpetualParams = PerpetualParams.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<MsgUpdatePerpetualParams>,
  ): MsgUpdatePerpetualParams {
    const message = createBaseMsgUpdatePerpetualParams();
    message.authority = object.authority ?? '';
    message.perpetualParams =
...
export const MsgUpdatePerpetualParamsResponse = {
  encode(
    _: MsgUpdatePerpetualParamsResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<MsgUpdatePerpetualParamsResponse>,
  ): MsgUpdatePerpetualParamsResponse {
    const message = createBaseMsgUpdatePerpetualParamsResponse();
    return message;
  },
...
export const MsgAddPremiumVotesResponse = {
  ...
  fromPartial(
    _: DeepPartial<MsgAddPremiumVotesResponse>,
  ): MsgAddPremiumVotesResponse {
    const message = createBaseMsgAddPremiumVotesResponse();
    return message;
  },
