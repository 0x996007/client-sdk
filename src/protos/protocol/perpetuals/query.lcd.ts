...
import {
  ...
  QueryPerpetualResponseSDKType,
  QueryAllPerpetualsRequest,
  QueryAllPerpetualsResponseSDKType,
  ...
  QueryNextPerpetualIdResponseSDKType,
} from './query.js';
export class LCDQueryClient {
  ...
  async perpetual(
    params: QueryPerpetualRequest,
  ): Promise<QueryPerpetualResponseSDKType> {
  ...
  async allPerpetuals(
    params: QueryAllPerpetualsRequest = {
    ...
    return await this.req.get<QueryAllPerpetualsResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async allLiquidityTiers(
    params: QueryAllLiquidityTiersRequest = {
      pagination: undefined,
    },
    ...
    return await this.req.get<QueryAllLiquidityTiersResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async premiumVotes(
    _params: QueryPremiumVotesRequest = {},
  ): Promise<QueryPremiumVotesResponseSDKType> {
  ...
  async premiumSamples(
    _params: QueryPremiumSamplesRequest = {},
  ): Promise<QueryPremiumSamplesResponseSDKType> {
  ...
  async nextPerpetualId(
    _params: QueryNextPerpetualIdRequest = {},
  ): Promise<QueryNextPerpetualIdResponseSDKType> {
