...
export interface Msg {
   ...
   */
  addPremiumVotes(
    request: MsgAddPremiumVotes,
  ): Promise<MsgAddPremiumVotesResponse>;
  /** CreatePerpetual creates a new perpetual object. */

  createPerpetual(
    request: MsgCreatePerpetual,
  ): Promise<MsgCreatePerpetualResponse>;
  /**
  ...
  setLiquidityTier(
    request: MsgSetLiquidityTier,
  ): Promise<MsgSetLiquidityTierResponse>;
  /** UpdatePerpetualParams updates the parameters of a perpetual market. */

  updatePerpetualParams(
    request: MsgUpdatePerpetualParams,
  ): Promise<MsgUpdatePerpetualParamsResponse>;
...
export class MsgClientImpl implements Msg {
  ...
  addPremiumVotes(
    ...
    return promise.then((data) =>
      MsgAddPremiumVotesResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  createPerpetual(
    ...
    return promise.then((data) =>
      MsgCreatePerpetualResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  setLiquidityTier(
    ...
    return promise.then((data) =>
      MsgSetLiquidityTierResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  updatePerpetualParams(
    ...
    return promise.then((data) =>
      MsgUpdatePerpetualParamsResponse.decode(new _m0.Reader(data)),
    );
  }
