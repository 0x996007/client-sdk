...
export interface Query {
  ...
  allPerpetuals(
    request?: QueryAllPerpetualsRequest,
  ): Promise<QueryAllPerpetualsResponse>;
  /** Queries a list of LiquidityTiers. */

  allLiquidityTiers(
    request?: QueryAllLiquidityTiersRequest,
  ): Promise<QueryAllLiquidityTiersResponse>;
  /** Queries a list of premium votes. */

  premiumVotes(
    request?: QueryPremiumVotesRequest,
  ): Promise<QueryPremiumVotesResponse>;
  /** Queries a list of premium samples. */

  premiumSamples(
    request?: QueryPremiumSamplesRequest,
  ): Promise<QueryPremiumSamplesResponse>;
  ...
  nextPerpetualId(
    request?: QueryNextPerpetualIdRequest,
  ): Promise<QueryNextPerpetualIdResponse>;
}
export class QueryClientImpl implements Query {
  ...
  perpetual(request: QueryPerpetualRequest): Promise<QueryPerpetualResponse> {
    ...
    const promise = this.rpc.request(
      'dydxprotocol.perpetuals.Query',
      'Perpetual',
      data,
    );
    return promise.then((data) =>
      QueryPerpetualResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  allPerpetuals(
    ...
    return promise.then((data) =>
      QueryAllPerpetualsResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  allLiquidityTiers(
    ...
    return promise.then((data) =>
      QueryAllLiquidityTiersResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  premiumVotes(
    ...
    return promise.then((data) =>
      QueryPremiumVotesResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  premiumSamples(
    ...
    return promise.then((data) =>
      QueryPremiumSamplesResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  nextPerpetualId(
    ...
    return promise.then((data) =>
      QueryNextPerpetualIdResponse.decode(new _m0.Reader(data)),
    );
  }
}
