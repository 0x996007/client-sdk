...
export const QueryPerpetualRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryPerpetualRequest>,
  ): QueryPerpetualRequest {
    const message = createBaseQueryPerpetualRequest();
...
export const QueryPerpetualResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryPerpetualResponse>,
  ): QueryPerpetualResponse {
    const message = createBaseQueryPerpetualResponse();
    message.perpetual =
      object.perpetual !== undefined && object.perpetual !== null
        ? Perpetual.fromPartial(object.perpetual)
        : undefined;
    return message;
  },
};
...
export const QueryAllPerpetualsRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryAllPerpetualsRequest>,
  ): QueryAllPerpetualsRequest {
    const message = createBaseQueryAllPerpetualsRequest();
    message.pagination =
...
export const QueryAllPerpetualsResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryAllPerpetualsResponse>,
  ): QueryAllPerpetualsResponse {
    const message = createBaseQueryAllPerpetualsResponse();
    message.perpetual =
      object.perpetual?.map((e) => Perpetual.fromPartial(e)) || [];
    message.pagination =
      object.pagination !== undefined && object.pagination !== null
...
export const QueryAllLiquidityTiersRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryAllLiquidityTiersRequest>,
  ): QueryAllLiquidityTiersRequest {
    const message = createBaseQueryAllLiquidityTiersRequest();
    message.pagination =
      object.pagination !== undefined && object.pagination !== null
...
export const QueryAllLiquidityTiersResponse = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.liquidityTiers.push(
            LiquidityTier.decode(reader, reader.uint32()),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<QueryAllLiquidityTiersResponse>,
  ): QueryAllLiquidityTiersResponse {
    const message = createBaseQueryAllLiquidityTiersResponse();
...
export const QueryPremiumVotesRequest = {
  ...
  fromPartial(
    _: DeepPartial<QueryPremiumVotesRequest>,
  ): QueryPremiumVotesRequest {
    const message = createBaseQueryPremiumVotesRequest();
    return message;
  },
...
export const QueryPremiumVotesResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryPremiumVotesResponse>,
  ): QueryPremiumVotesResponse {
    const message = createBaseQueryPremiumVotesResponse();
    message.premiumVotes =
      object.premiumVotes !== undefined && object.premiumVotes !== null
...
export const QueryPremiumSamplesRequest = {
  ...
  fromPartial(
    _: DeepPartial<QueryPremiumSamplesRequest>,
  ): QueryPremiumSamplesRequest {
    const message = createBaseQueryPremiumSamplesRequest();
    return message;
  },
...
export const QueryPremiumSamplesResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryPremiumSamplesResponse>,
  ): QueryPremiumSamplesResponse {
    const message = createBaseQueryPremiumSamplesResponse();
    message.premiumSamples =
      object.premiumSamples !== undefined && object.premiumSamples !== null
        ? PremiumStore.fromPartial(object.premiumSamples)
        : undefined;
    return message;
  },
};
...
export const QueryNextPerpetualIdRequest = {
  ...
  fromPartial(
    _: DeepPartial<QueryNextPerpetualIdRequest>,
  ): QueryNextPerpetualIdRequest {
    const message = createBaseQueryNextPerpetualIdRequest();
    return message;
  },
...
export const QueryNextPerpetualIdResponse = {
  encode(
    message: QueryNextPerpetualIdResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
  ...
  fromPartial(
    object: DeepPartial<QueryNextPerpetualIdResponse>,
  ): QueryNextPerpetualIdResponse {
    const message = createBaseQueryNextPerpetualIdResponse();
