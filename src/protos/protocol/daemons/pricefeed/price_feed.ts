...
export const UpdateMarketPricesRequest = {
      ...
      switch (tag >>> 3) {
        case 1:
          message.marketPriceUpdates.push(
            MarketPriceUpdate.decode(reader, reader.uint32()),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<UpdateMarketPricesRequest>,
  ): UpdateMarketPricesRequest {
    const message = createBaseUpdateMarketPricesRequest();
...
export const UpdateMarketPricesResponse = {
  ...
  fromPartial(
    _: DeepPartial<UpdateMarketPricesResponse>,
  ): UpdateMarketPricesResponse {
    const message = createBaseUpdateMarketPricesResponse();
    return message;
  },
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MarketPriceUpdate {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          message.exchangePrices.push(
            ExchangePrice.decode(reader, reader.uint32()),
          );
          break;
