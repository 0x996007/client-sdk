...
import { BridgeEvent, BridgeEventSDKType } from '../../bridge/bridge_event.js';
...
export const AddBridgeEventsRequest = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.bridgeEvents.push(
            BridgeEvent.decode(reader, reader.uint32()),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<AddBridgeEventsRequest>,
  ): AddBridgeEventsRequest {
    const message = createBaseAddBridgeEventsRequest();
...
export const AddBridgeEventsResponse = {
  ...
  fromPartial(
    _: DeepPartial<AddBridgeEventsResponse>,
  ): AddBridgeEventsResponse {
    const message = createBaseAddBridgeEventsResponse();
    return message;
  },
