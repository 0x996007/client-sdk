...
import {
  ...
  QuerySubaccountResponseSDKType,
  QueryAllSubaccountRequest,
  QuerySubaccountAllResponseSDKType,
  QueryGetWithdrawalAndTransfersBlockedInfoRequest,
  QueryGetWithdrawalAndTransfersBlockedInfoResponseSDKType,
  QueryCollateralPoolAddressRequest,
  QueryCollateralPoolAddressResponseSDKType,
} from './query.js';
export class LCDQueryClient {
  ...
  async subaccount(
    params: QueryGetSubaccountRequest,
  ): Promise<QuerySubaccountResponseSDKType> {
  ...
  async subaccountAll(
    params: QueryAllSubaccountRequest = {
    ...
    return await this.req.get<QuerySubaccountAllResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async getWithdrawalAndTransfersBlockedInfo(
    params: QueryGetWithdrawalAndTransfersBlockedInfoRequest,
  ): Promise<QueryGetWithdrawalAndTransfersBlockedInfoResponseSDKType> {
    const endpoint = `dydxprotocol/subaccounts/withdrawals_and_transfers_blocked_info/${params.perpetualId}`;
    return await this.req.get<QueryGetWithdrawalAndTransfersBlockedInfoResponseSDKType>(
      endpoint,
    );
  }
  /* Queries the collateral pool account address for a perpetual id. */

  async collateralPoolAddress(
    params: QueryCollateralPoolAddressRequest,
  ): Promise<QueryCollateralPoolAddressResponseSDKType> {
    const endpoint = `dydxprotocol/subaccounts/collateral_pool_address/${params.perpetualId}`;
    return await this.req.get<QueryCollateralPoolAddressResponseSDKType>(
      endpoint,
    );
  }
}
