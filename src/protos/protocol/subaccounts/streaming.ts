import { SubaccountId, SubaccountIdSDKType } from './subaccount.js';
...
export const StreamSubaccountUpdate = {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          message.updatedPerpetualPositions.push(
            SubaccountPerpetualPosition.decode(reader, reader.uint32()),
          );
          break;

        case 3:
          message.updatedAssetPositions.push(
            SubaccountAssetPosition.decode(reader, reader.uint32()),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<StreamSubaccountUpdate>,
  ): StreamSubaccountUpdate {
    const message = createBaseStreamSubaccountUpdate();
    message.subaccountId =
    ...
    message.updatedPerpetualPositions =
      object.updatedPerpetualPositions?.map((e) =>
        SubaccountPerpetualPosition.fromPartial(e),
      ) || [];
    message.updatedAssetPositions =
      object.updatedAssetPositions?.map((e) =>
        SubaccountAssetPosition.fromPartial(e),
      ) || [];
...
export const SubaccountPerpetualPosition = {
  ...
  fromPartial(
    object: DeepPartial<SubaccountPerpetualPosition>,
  ): SubaccountPerpetualPosition {
    const message = createBaseSubaccountPerpetualPosition();
...
export const SubaccountAssetPosition = {
  ...
  fromPartial(
    object: DeepPartial<SubaccountAssetPosition>,
  ): SubaccountAssetPosition {
    const message = createBaseSubaccountAssetPosition();
