...
export interface Query {
  ...
  ): Promise<QuerySubaccountResponse>;
  ...
  ): Promise<QueryGetWithdrawalAndTransfersBlockedInfoResponse>;
  /** Queries the collateral pool account address for a perpetual id. */

  collateralPoolAddress(
    request: QueryCollateralPoolAddressRequest,
  ): Promise<QueryCollateralPoolAddressResponse>;
}
export class QueryClientImpl implements Query {
  ...
  subaccount(
    ...
    return promise.then((data) =>
      QuerySubaccountResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  subaccountAll(
    ...
    return promise.then((data) =>
      QuerySubaccountAllResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  getWithdrawalAndTransfersBlockedInfo(
    ...
    const data =
      QueryGetWithdrawalAndTransfersBlockedInfoRequest.encode(request).finish();
    const promise = this.rpc.request(
      'dydxprotocol.subaccounts.Query',
      'GetWithdrawalAndTransfersBlockedInfo',
      data,
    ...
    return promise.then((data) =>
      QueryGetWithdrawalAndTransfersBlockedInfoResponse.decode(
        new _m0.Reader(data),
      ),
    );
  }
  ...
  collateralPoolAddress(
    ...
    return promise.then((data) =>
      QueryCollateralPoolAddressResponse.decode(new _m0.Reader(data)),
    );
  }
}
