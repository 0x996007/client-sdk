...
export const QuerySubaccountResponse = {
  ...
  fromPartial(
    object: DeepPartial<QuerySubaccountResponse>,
  ): QuerySubaccountResponse {
    const message = createBaseQuerySubaccountResponse();
    message.subaccount =
...
export const QuerySubaccountAllResponse = {
  ...
  fromPartial(
    object: DeepPartial<QuerySubaccountAllResponse>,
  ): QuerySubaccountAllResponse {
    const message = createBaseQuerySubaccountAllResponse();
    message.subaccount =
...
export const QueryGetWithdrawalAndTransfersBlockedInfoRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryGetWithdrawalAndTransfersBlockedInfoRequest>,
  ): QueryGetWithdrawalAndTransfersBlockedInfoRequest {
    const message =
      createBaseQueryGetWithdrawalAndTransfersBlockedInfoRequest();
...
export const QueryGetWithdrawalAndTransfersBlockedInfoResponse = {
  ...
  decode(
    ...
    const end = length === undefined ? reader.len : reader.pos + length;
    const message =
      createBaseQueryGetWithdrawalAndTransfersBlockedInfoResponse();
  ...
  fromPartial(
    object: DeepPartial<QueryGetWithdrawalAndTransfersBlockedInfoResponse>,
  ): QueryGetWithdrawalAndTransfersBlockedInfoResponse {
    const message =
      createBaseQueryGetWithdrawalAndTransfersBlockedInfoResponse();
...
export const QueryCollateralPoolAddressRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryCollateralPoolAddressRequest>,
  ): QueryCollateralPoolAddressRequest {
    const message = createBaseQueryCollateralPoolAddressRequest();
    message.perpetualId = object.perpetualId ?? 0;
    return message;
...
export const QueryCollateralPoolAddressResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryCollateralPoolAddressResponse>,
  ): QueryCollateralPoolAddressResponse {
    const message = createBaseQueryCollateralPoolAddressResponse();
