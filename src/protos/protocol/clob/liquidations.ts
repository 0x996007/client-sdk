...
export const PerpetualLiquidationInfo = {
  ...
  fromPartial(
    object: DeepPartial<PerpetualLiquidationInfo>,
  ): PerpetualLiquidationInfo {
    const message = createBasePerpetualLiquidationInfo();
    message.subaccountId =
...
export const SubaccountLiquidationInfo = {
  ...
  fromPartial(
    object: DeepPartial<SubaccountLiquidationInfo>,
  ): SubaccountLiquidationInfo {
    const message = createBaseSubaccountLiquidationInfo();
    message.perpetualsLiquidated =
      object.perpetualsLiquidated?.map((e) => e) || [];
    message.notionalLiquidated =
      object.notionalLiquidated !== undefined &&
      object.notionalLiquidated !== null
        ? Long.fromValue(object.notionalLiquidated)
        : Long.UZERO;
    message.quantumsInsuranceLost =
      object.quantumsInsuranceLost !== undefined &&
      object.quantumsInsuranceLost !== null
        ? Long.fromValue(object.quantumsInsuranceLost)
        : Long.UZERO;
    return message;
  },
};
...
export const SubaccountOpenPositionInfo = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          message.subaccountsWithLongPosition.push(
            SubaccountId.decode(reader, reader.uint32()),
          );
          break;

        case 3:
          message.subaccountsWithShortPosition.push(
            SubaccountId.decode(reader, reader.uint32()),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<SubaccountOpenPositionInfo>,
  ): SubaccountOpenPositionInfo {
    const message = createBaseSubaccountOpenPositionInfo();
    message.perpetualId = object.perpetualId ?? 0;
    message.subaccountsWithLongPosition =
      object.subaccountsWithLongPosition?.map((e) =>
        SubaccountId.fromPartial(e),
      ) || [];
    message.subaccountsWithShortPosition =
      object.subaccountsWithShortPosition?.map((e) =>
        SubaccountId.fromPartial(e),
      ) || [];
    return message;
  },
