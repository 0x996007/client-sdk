...
export const MsgCreateClobPairResponse = {
  ...
  fromPartial(
    _: DeepPartial<MsgCreateClobPairResponse>,
  ): MsgCreateClobPairResponse {
    const message = createBaseMsgCreateClobPairResponse();
    return message;
  },
...
export const MsgProposedOperations = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.operationsQueue.push(
            OperationRaw.decode(reader, reader.uint32()),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<MsgProposedOperations>,
  ): MsgProposedOperations {
    const message = createBaseMsgProposedOperations();
    message.operationsQueue =
      object.operationsQueue?.map((e) => OperationRaw.fromPartial(e)) || [];
    return message;
  },
};
...
export const MsgProposedOperationsResponse = {
  encode(
    _: MsgProposedOperationsResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<MsgProposedOperationsResponse>,
  ): MsgProposedOperationsResponse {
    const message = createBaseMsgProposedOperationsResponse();
    return message;
  },
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgBatchCancel {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          message.shortTermCancels.push(
            OrderBatch.decode(reader, reader.uint32()),
          );
          break;
  ...
  fromPartial(object: DeepPartial<MsgBatchCancel>): MsgBatchCancel {
    ...
    message.subaccountId =
      object.subaccountId !== undefined && object.subaccountId !== null
        ...
        : undefined;
    message.shortTermCancels =
      object.shortTermCancels?.map((e) => OrderBatch.fromPartial(e)) || [];
...
export const MsgBatchCancelResponse = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.shortTermSucceeded.push(
            OrderBatch.decode(reader, reader.uint32()),
          );
          break;

        case 2:
          message.shortTermFailed.push(
            OrderBatch.decode(reader, reader.uint32()),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<MsgBatchCancelResponse>,
  ): MsgBatchCancelResponse {
    const message = createBaseMsgBatchCancelResponse();
    message.shortTermSucceeded =
      object.shortTermSucceeded?.map((e) => OrderBatch.fromPartial(e)) || [];
    message.shortTermFailed =
      object.shortTermFailed?.map((e) => OrderBatch.fromPartial(e)) || [];
    return message;
  },
};
...
export const MsgUpdateClobPairResponse = {
  ...
  fromPartial(
    _: DeepPartial<MsgUpdateClobPairResponse>,
  ): MsgUpdateClobPairResponse {
    const message = createBaseMsgUpdateClobPairResponse();
    return message;
  },
...
export const MsgUpdateEquityTierLimitConfiguration = {
  ...
  fromPartial(
    object: DeepPartial<MsgUpdateEquityTierLimitConfiguration>,
  ): MsgUpdateEquityTierLimitConfiguration {
    const message = createBaseMsgUpdateEquityTierLimitConfiguration();
    message.authority = object.authority ?? '';
    message.equityTierLimitConfig =
...
export const MsgUpdateEquityTierLimitConfigurationResponse = {
  encode(
    _: MsgUpdateEquityTierLimitConfigurationResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<MsgUpdateEquityTierLimitConfigurationResponse>,
  ): MsgUpdateEquityTierLimitConfigurationResponse {
    const message = createBaseMsgUpdateEquityTierLimitConfigurationResponse();
    return message;
  },
...
export const MsgUpdateBlockRateLimitConfiguration = {
  ...
  fromPartial(
    object: DeepPartial<MsgUpdateBlockRateLimitConfiguration>,
  ): MsgUpdateBlockRateLimitConfiguration {
    const message = createBaseMsgUpdateBlockRateLimitConfiguration();
    message.authority = object.authority ?? '';
    message.blockRateLimitConfig =
...
export const MsgUpdateBlockRateLimitConfigurationResponse = {
  encode(
    _: MsgUpdateBlockRateLimitConfigurationResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<MsgUpdateBlockRateLimitConfigurationResponse>,
  ): MsgUpdateBlockRateLimitConfigurationResponse {
    const message = createBaseMsgUpdateBlockRateLimitConfigurationResponse();
    return message;
  },
...
export const MsgUpdateLiquidationsConfig = {
  ...
  fromPartial(
    object: DeepPartial<MsgUpdateLiquidationsConfig>,
  ): MsgUpdateLiquidationsConfig {
    const message = createBaseMsgUpdateLiquidationsConfig();
    message.authority = object.authority ?? '';
    message.liquidationsConfig =
...
export const MsgUpdateLiquidationsConfigResponse = {
  encode(
    _: MsgUpdateLiquidationsConfigResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<MsgUpdateLiquidationsConfigResponse>,
  ): MsgUpdateLiquidationsConfigResponse {
    const message = createBaseMsgUpdateLiquidationsConfigResponse();
    return message;
  },
