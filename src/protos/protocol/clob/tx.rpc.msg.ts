...
export interface Msg {
   ...
   */
  proposedOperations(
    request: MsgProposedOperations,
  ): Promise<MsgProposedOperationsResponse>;
  ...
  createClobPair(
    request: MsgCreateClobPair,
  ): Promise<MsgCreateClobPairResponse>;
  /**
  ...
  updateClobPair(
    request: MsgUpdateClobPair,
  ): Promise<MsgUpdateClobPairResponse>;
  /**
  ...
  ): Promise<MsgUpdateEquityTierLimitConfigurationResponse>;
  /**
  ...
  updateBlockRateLimitConfiguration(
    request: MsgUpdateBlockRateLimitConfiguration,
  ): Promise<MsgUpdateBlockRateLimitConfigurationResponse>;
  /** UpdateLiquidationsConfig updates the liquidations configuration in state. */

  updateLiquidationsConfig(
    request: MsgUpdateLiquidationsConfig,
  ): Promise<MsgUpdateLiquidationsConfigResponse>;
}
export class MsgClientImpl implements Msg {
  ...
  proposedOperations(
    ...
    return promise.then((data) =>
      MsgProposedOperationsResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  placeOrder(request: MsgPlaceOrder): Promise<MsgPlaceOrderResponse> {
    ...
    return promise.then((data) =>
      MsgPlaceOrderResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  batchCancel(request: MsgBatchCancel): Promise<MsgBatchCancelResponse> {
    ...
    return promise.then((data) =>
      MsgBatchCancelResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  createClobPair(
    ...
    return promise.then((data) =>
      MsgCreateClobPairResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  updateClobPair(
    ...
    return promise.then((data) =>
      MsgUpdateClobPairResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  updateEquityTierLimitConfiguration(
    ...
    return promise.then((data) =>
      MsgUpdateEquityTierLimitConfigurationResponse.decode(
        new _m0.Reader(data),
      ),
    );
  }
  ...
  updateBlockRateLimitConfiguration(
    ...
    return promise.then((data) =>
      MsgUpdateBlockRateLimitConfigurationResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  updateLiquidationsConfig(
    ...
    return promise.then((data) =>
      MsgUpdateLiquidationsConfigResponse.decode(new _m0.Reader(data)),
    );
  }
}
