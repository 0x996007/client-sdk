...
import {
  ...
  QueryClobPairResponseSDKType,
  QueryAllClobPairRequest,
  QueryClobPairAllResponseSDKType,
  QueryEquityTierLimitConfigurationRequest,
  QueryEquityTierLimitConfigurationResponseSDKType,
  QueryBlockRateLimitConfigurationRequest,
  QueryBlockRateLimitConfigurationResponseSDKType,
  QueryLiquidationsConfigurationRequest,
  QueryLiquidationsConfigurationResponseSDKType,
  QueryNextClobPairIdRequest,
  QueryNextClobPairIdResponseSDKType,
} from './query.js';
export class LCDQueryClient {
  ...
  async clobPair(
    params: QueryGetClobPairRequest,
  ): Promise<QueryClobPairResponseSDKType> {
  ...
  async clobPairAll(
    params: QueryAllClobPairRequest = {
    ...
    return await this.req.get<QueryClobPairAllResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async equityTierLimitConfiguration(
    _params: QueryEquityTierLimitConfigurationRequest = {},
  ): Promise<QueryEquityTierLimitConfigurationResponseSDKType> {
    const endpoint = `dydxprotocol/clob/equity_tier`;
    return await this.req.get<QueryEquityTierLimitConfigurationResponseSDKType>(
      endpoint,
    );
  }
  /* Queries BlockRateLimitConfiguration. */

  async blockRateLimitConfiguration(
    _params: QueryBlockRateLimitConfigurationRequest = {},
  ): Promise<QueryBlockRateLimitConfigurationResponseSDKType> {
    const endpoint = `dydxprotocol/clob/block_rate`;
    return await this.req.get<QueryBlockRateLimitConfigurationResponseSDKType>(
      endpoint,
    );
  }
  /* Queries LiquidationsConfiguration. */

  async liquidationsConfiguration(
    _params: QueryLiquidationsConfigurationRequest = {},
  ): Promise<QueryLiquidationsConfigurationResponseSDKType> {
    const endpoint = `dydxprotocol/clob/liquidations_config`;
    return await this.req.get<QueryLiquidationsConfigurationResponseSDKType>(
      endpoint,
    );
  }
  /* Queries the next clob pair id. */

  async nextClobPairId(
    _params: QueryNextClobPairIdRequest = {},
  ): Promise<QueryNextClobPairIdResponseSDKType> {
