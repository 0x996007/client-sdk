...
export const ProcessProposerMatchesEvents = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.placedLongTermOrderIds.push(
            OrderId.decode(reader, reader.uint32()),
          );
          break;

        case 2:
          message.expiredStatefulOrderIds.push(
            OrderId.decode(reader, reader.uint32()),
          );
          break;

        case 3:
          message.orderIdsFilledInLastBlock.push(
            OrderId.decode(reader, reader.uint32()),
          );
          break;

        case 4:
          message.placedStatefulCancellationOrderIds.push(
            OrderId.decode(reader, reader.uint32()),
          );
          break;

        case 5:
          message.removedStatefulOrderIds.push(
            OrderId.decode(reader, reader.uint32()),
          );
          break;

        case 6:
          message.conditionalOrderIdsTriggeredInLastBlock.push(
            OrderId.decode(reader, reader.uint32()),
          );
          break;

        case 7:
          message.placedConditionalOrderIds.push(
            OrderId.decode(reader, reader.uint32()),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<ProcessProposerMatchesEvents>,
  ): ProcessProposerMatchesEvents {
    const message = createBaseProcessProposerMatchesEvents();
    ...
    message.placedStatefulCancellationOrderIds =
      object.placedStatefulCancellationOrderIds?.map((e) =>
        OrderId.fromPartial(e),
      ) || [];
    ...
    message.conditionalOrderIdsTriggeredInLastBlock =
      object.conditionalOrderIdsTriggeredInLastBlock?.map((e) =>
        OrderId.fromPartial(e),
      ) || [];
