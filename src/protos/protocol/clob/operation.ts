...
import {
  MsgPlaceOrder,
  MsgPlaceOrderSDKType,
  MsgCancelOrder,
  MsgCancelOrderSDKType,
} from './tx.js';
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Operation {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          message.shortTermOrderPlacement = MsgPlaceOrder.decode(
            reader,
            reader.uint32(),
          );
          break;
        ...
        case 3:
          message.shortTermOrderCancellation = MsgCancelOrder.decode(
            reader,
            reader.uint32(),
          );
          break;
        ...
        case 4:
          message.preexistingStatefulOrder = OrderId.decode(
            reader,
            reader.uint32(),
          );
          break;
