...
export const MEVMatch = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MEVMatch {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.takerOrderSubaccountId = SubaccountId.decode(
            reader,
            reader.uint32(),
          );
          break;
        ...
        case 3:
          message.makerOrderSubaccountId = SubaccountId.decode(
            reader,
            reader.uint32(),
          );
          break;
...
export const MEVLiquidationMatch = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MEVLiquidationMatch {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.liquidatedSubaccountId = SubaccountId.decode(
            reader,
            reader.uint32(),
          );
          break;
...
export const ValidatorMevMatches = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ValidatorMevMatches {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          message.liquidationMatches.push(
            MEVLiquidationMatch.decode(reader, reader.uint32()),
          );
          break;
  ...
  fromPartial(object: DeepPartial<ValidatorMevMatches>): ValidatorMevMatches {
    ...
    message.liquidationMatches =
      object.liquidationMatches?.map((e) =>
        MEVLiquidationMatch.fromPartial(e),
      ) || [];
    return message;
  },
};
...
export const MevNodeToNodeMetrics = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.validatorMevMatches = ValidatorMevMatches.decode(
            reader,
            reader.uint32(),
          );
          break;
        ...
        case 2:
          message.clobMidPrices.push(
            ClobMidPrice.decode(reader, reader.uint32()),
          );
          break;

        case 3:
          message.bpMevMatches = ValidatorMevMatches.decode(
            reader,
            reader.uint32(),
          );
          break;
