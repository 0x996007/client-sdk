...
export const ClobMatch = {
  encode(
    ...
    if (message.matchPerpetualLiquidation !== undefined) {
      MatchPerpetualLiquidation.encode(
    ...
    if (message.matchPerpetualDeleveraging !== undefined) {
      MatchPerpetualDeleveraging.encode(
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ClobMatch {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          message.matchPerpetualLiquidation = MatchPerpetualLiquidation.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromPartial(object: DeepPartial<ClobMatch>): ClobMatch {
    ...
    message.matchPerpetualLiquidation =
      ...
      object.matchPerpetualLiquidation !== null
        ? MatchPerpetualLiquidation.fromPartial(
            object.matchPerpetualLiquidation,
          )
        : undefined;
    message.matchPerpetualDeleveraging =
      object.matchPerpetualDeleveraging !== undefined &&
      object.matchPerpetualDeleveraging !== null
        ? MatchPerpetualDeleveraging.fromPartial(
...
export const MatchPerpetualLiquidation = {
  ...
  fromPartial(
    object: DeepPartial<MatchPerpetualLiquidation>,
  ): MatchPerpetualLiquidation {
    const message = createBaseMatchPerpetualLiquidation();
    message.liquidated =
...
export const MatchPerpetualDeleveraging = {
  encode(
    ...
    for (const v of message.fills) {
      MatchPerpetualDeleveraging_Fill.encode(
        v!,
        writer.uint32(26).fork(),
      ).ldelim();
    }
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          message.fills.push(
            MatchPerpetualDeleveraging_Fill.decode(reader, reader.uint32()),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<MatchPerpetualDeleveraging>,
  ): MatchPerpetualDeleveraging {
    const message = createBaseMatchPerpetualDeleveraging();
    message.liquidated =
      object.liquidated !== undefined && object.liquidated !== null
    ...
    message.fills =
      object.fills?.map((e) =>
        MatchPerpetualDeleveraging_Fill.fromPartial(e),
      ) || [];
...
export const MatchPerpetualDeleveraging_Fill = {
  encode(
    message: MatchPerpetualDeleveraging_Fill,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.offsettingSubaccountId = SubaccountId.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<MatchPerpetualDeleveraging_Fill>,
  ): MatchPerpetualDeleveraging_Fill {
    const message = createBaseMatchPerpetualDeleveraging_Fill();
    message.offsettingSubaccountId =
