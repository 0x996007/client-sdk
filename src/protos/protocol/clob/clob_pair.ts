...
export const PerpetualClobMetadata = {
  ...
  fromPartial(
    object: DeepPartial<PerpetualClobMetadata>,
  ): PerpetualClobMetadata {
    const message = createBasePerpetualClobMetadata();
...
export const ClobPair = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ClobPair {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          message.perpetualClobMetadata = PerpetualClobMetadata.decode(
            reader,
            reader.uint32(),
          );
          break;
        ...
        case 3:
          message.spotClobMetadata = SpotClobMetadata.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromPartial(object: DeepPartial<ClobPair>): ClobPair {
    ...
    message.perpetualClobMetadata =
      object.perpetualClobMetadata !== undefined &&
      object.perpetualClobMetadata !== null
        ? PerpetualClobMetadata.fromPartial(object.perpetualClobMetadata)
        : undefined;
    message.spotClobMetadata =
      object.spotClobMetadata !== undefined && object.spotClobMetadata !== null
        ? SpotClobMetadata.fromPartial(object.spotClobMetadata)
        : undefined;
