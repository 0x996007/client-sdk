...
export interface Query {
  ...
  clobPairAll(
    request?: QueryAllClobPairRequest,
  ): Promise<QueryClobPairAllResponse>;
  /** Runs the MEV node <> node calculation with the provided parameters. */

  mevNodeToNodeCalculation(
    request: MevNodeToNodeCalculationRequest,
  ): Promise<MevNodeToNodeCalculationResponse>;
  /** Queries EquityTierLimitConfiguration. */

  equityTierLimitConfiguration(
    request?: QueryEquityTierLimitConfigurationRequest,
  ): Promise<QueryEquityTierLimitConfigurationResponse>;
  /** Queries BlockRateLimitConfiguration. */

  blockRateLimitConfiguration(
    request?: QueryBlockRateLimitConfigurationRequest,
  ): Promise<QueryBlockRateLimitConfigurationResponse>;
  /** Queries LiquidationsConfiguration. */

  liquidationsConfiguration(
    request?: QueryLiquidationsConfigurationRequest,
  ): Promise<QueryLiquidationsConfigurationResponse>;
  /** Queries the stateful order for a given order id. */

  statefulOrder(
    request: QueryStatefulOrderRequest,
  ): Promise<QueryStatefulOrderResponse>;
  /** Queries the next clob pair id. */

  nextClobPairId(
    request?: QueryNextClobPairIdRequest,
  ): Promise<QueryNextClobPairIdResponse>;
  /**
  ...
  ): Promise<StreamOrderbookUpdatesResponse>;
}
export class QueryClientImpl implements Query {
  ...
  clobPair(request: QueryGetClobPairRequest): Promise<QueryClobPairResponse> {
    ...
    return promise.then((data) =>
      QueryClobPairResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  clobPairAll(
    ...
    return promise.then((data) =>
      QueryClobPairAllResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  mevNodeToNodeCalculation(
    ...
    return promise.then((data) =>
      MevNodeToNodeCalculationResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  equityTierLimitConfiguration(
    ...
    const data =
      QueryEquityTierLimitConfigurationRequest.encode(request).finish();
    const promise = this.rpc.request(
      'dydxprotocol.clob.Query',
      'EquityTierLimitConfiguration',
      data,
    ...
    return promise.then((data) =>
      QueryEquityTierLimitConfigurationResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  blockRateLimitConfiguration(
    ...
    const data =
      QueryBlockRateLimitConfigurationRequest.encode(request).finish();
    const promise = this.rpc.request(
      'dydxprotocol.clob.Query',
      'BlockRateLimitConfiguration',
      data,
    ...
    return promise.then((data) =>
      QueryBlockRateLimitConfigurationResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  liquidationsConfiguration(
    ...
    return promise.then((data) =>
      QueryLiquidationsConfigurationResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  statefulOrder(
    ...
    return promise.then((data) =>
      QueryStatefulOrderResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  nextClobPairId(
    ...
    return promise.then((data) =>
      QueryNextClobPairIdResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  streamOrderbookUpdates(
    ...
    return promise.then((data) =>
      StreamOrderbookUpdatesResponse.decode(new _m0.Reader(data)),
    );
  }
}
