...
import {
  ValidatorMevMatches,
  ValidatorMevMatchesSDKType,
  MevNodeToNodeMetrics,
  MevNodeToNodeMetricsSDKType,
} from './mev.js';
import {
  OrderId,
  OrderIdSDKType,
  LongTermOrderPlacement,
  LongTermOrderPlacementSDKType,
  Order,
  OrderSDKType,
...
import {
  SubaccountId,
  SubaccountIdSDKType,
} from '../subaccounts/subaccount.js';
import { ClobPair, ClobPairSDKType } from './clob_pair.js';
import {
  EquityTierLimitConfiguration,
  EquityTierLimitConfigurationSDKType,
} from './equity_tier_limit_config.js';
import {
  BlockRateLimitConfiguration,
  BlockRateLimitConfigurationSDKType,
} from './block_rate_limit_config.js';
import {
  LiquidationsConfig,
  LiquidationsConfigSDKType,
} from './liquidations_config.js';
import {
  StreamSubaccountUpdate,
  StreamSubaccountUpdateSDKType,
} from '../subaccounts/streaming.js';
import {
  StreamPriceUpdate,
  StreamPriceUpdateSDKType,
} from '../prices/streaming.js';
import {
  OffChainUpdateV1,
  OffChainUpdateV1SDKType,
} from '../indexer/off_chain_updates/off_chain_updates.js';
...
export const QueryGetClobPairRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryGetClobPairRequest>,
  ): QueryGetClobPairRequest {
    const message = createBaseQueryGetClobPairRequest();
...
export const QueryClobPairResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryClobPairResponse>,
  ): QueryClobPairResponse {
    const message = createBaseQueryClobPairResponse();
    message.clobPair =
...
export const QueryAllClobPairRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryAllClobPairRequest>,
  ): QueryAllClobPairRequest {
    const message = createBaseQueryAllClobPairRequest();
    message.pagination =
...
export const QueryClobPairAllResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryClobPairAllResponse>,
  ): QueryClobPairAllResponse {
    const message = createBaseQueryClobPairAllResponse();
    message.clobPair =
...
export const MevNodeToNodeCalculationRequest = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.blockProposerMatches = ValidatorMevMatches.decode(
            reader,
            reader.uint32(),
          );
          break;
        ...
        case 2:
          message.validatorMevMetrics = MevNodeToNodeMetrics.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<MevNodeToNodeCalculationRequest>,
  ): MevNodeToNodeCalculationRequest {
    const message = createBaseMevNodeToNodeCalculationRequest();
    message.blockProposerMatches =
...
export const MevNodeToNodeCalculationResponse = {
  encode(
    ...
    for (const v of message.results) {
      MevNodeToNodeCalculationResponse_MevAndVolumePerClob.encode(
        v!,
        writer.uint32(10).fork(),
      ).ldelim();
    }
      ...
      switch (tag >>> 3) {
        case 1:
          message.results.push(
            MevNodeToNodeCalculationResponse_MevAndVolumePerClob.decode(
              reader,
              reader.uint32(),
            ),
          );
  ...
  fromPartial(
    object: DeepPartial<MevNodeToNodeCalculationResponse>,
  ): MevNodeToNodeCalculationResponse {
    const message = createBaseMevNodeToNodeCalculationResponse();
    message.results =
      object.results?.map((e) =>
        MevNodeToNodeCalculationResponse_MevAndVolumePerClob.fromPartial(e),
      ) || [];
    return message;
  },
};
...
export const MevNodeToNodeCalculationResponse_MevAndVolumePerClob = {
  encode(
    message: MevNodeToNodeCalculationResponse_MevAndVolumePerClob,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
  ...
  fromPartial(
    object: DeepPartial<MevNodeToNodeCalculationResponse_MevAndVolumePerClob>,
  ): MevNodeToNodeCalculationResponse_MevAndVolumePerClob {
    const message =
      createBaseMevNodeToNodeCalculationResponse_MevAndVolumePerClob();
...
export const QueryEquityTierLimitConfigurationRequest = {
  encode(
    _: QueryEquityTierLimitConfigurationRequest,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<QueryEquityTierLimitConfigurationRequest>,
  ): QueryEquityTierLimitConfigurationRequest {
    const message = createBaseQueryEquityTierLimitConfigurationRequest();
    return message;
  },
...
export const QueryEquityTierLimitConfigurationResponse = {
  encode(
    ...
    if (message.equityTierLimitConfig !== undefined) {
      EquityTierLimitConfiguration.encode(
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.equityTierLimitConfig = EquityTierLimitConfiguration.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<QueryEquityTierLimitConfigurationResponse>,
  ): QueryEquityTierLimitConfigurationResponse {
    const message = createBaseQueryEquityTierLimitConfigurationResponse();
    message.equityTierLimitConfig =
...
export const QueryBlockRateLimitConfigurationRequest = {
  encode(
    _: QueryBlockRateLimitConfigurationRequest,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<QueryBlockRateLimitConfigurationRequest>,
  ): QueryBlockRateLimitConfigurationRequest {
    const message = createBaseQueryBlockRateLimitConfigurationRequest();
    return message;
  },
...
export const QueryBlockRateLimitConfigurationResponse = {
  encode(
    ...
    if (message.blockRateLimitConfig !== undefined) {
      BlockRateLimitConfiguration.encode(
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.blockRateLimitConfig = BlockRateLimitConfiguration.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<QueryBlockRateLimitConfigurationResponse>,
  ): QueryBlockRateLimitConfigurationResponse {
    const message = createBaseQueryBlockRateLimitConfigurationResponse();
    message.blockRateLimitConfig =
...
export const QueryStatefulOrderRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryStatefulOrderRequest>,
  ): QueryStatefulOrderRequest {
    const message = createBaseQueryStatefulOrderRequest();
    message.orderId =
...
export const QueryStatefulOrderResponse = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.orderPlacement = LongTermOrderPlacement.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<QueryStatefulOrderResponse>,
  ): QueryStatefulOrderResponse {
    const message = createBaseQueryStatefulOrderResponse();
    message.orderPlacement =
...
export const QueryLiquidationsConfigurationRequest = {
  encode(
    _: QueryLiquidationsConfigurationRequest,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<QueryLiquidationsConfigurationRequest>,
  ): QueryLiquidationsConfigurationRequest {
    const message = createBaseQueryLiquidationsConfigurationRequest();
    return message;
  },
...
export const QueryLiquidationsConfigurationResponse = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.liquidationsConfig = LiquidationsConfig.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<QueryLiquidationsConfigurationResponse>,
  ): QueryLiquidationsConfigurationResponse {
    const message = createBaseQueryLiquidationsConfigurationResponse();
    message.liquidationsConfig =
...
export const QueryNextClobPairIdRequest = {
  ...
  fromPartial(
    _: DeepPartial<QueryNextClobPairIdRequest>,
  ): QueryNextClobPairIdRequest {
    const message = createBaseQueryNextClobPairIdRequest();
    return message;
  },
...
export const QueryNextClobPairIdResponse = {
  encode(
    message: QueryNextClobPairIdResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
  ...
  fromPartial(
    object: DeepPartial<QueryNextClobPairIdResponse>,
  ): QueryNextClobPairIdResponse {
    const message = createBaseQueryNextClobPairIdResponse();
...
export const StreamOrderbookUpdatesRequest = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          message.subaccountIds.push(
            SubaccountId.decode(reader, reader.uint32()),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<StreamOrderbookUpdatesRequest>,
  ): StreamOrderbookUpdatesRequest {
    const message = createBaseStreamOrderbookUpdatesRequest();
...
export const StreamOrderbookUpdatesResponse = {
  ...
  fromPartial(
    object: DeepPartial<StreamOrderbookUpdatesResponse>,
  ): StreamOrderbookUpdatesResponse {
    const message = createBaseStreamOrderbookUpdatesResponse();
    message.updates =
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): StreamUpdate {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          message.orderbookUpdate = StreamOrderbookUpdate.decode(
            reader,
            reader.uint32(),
          );
          break;
        ...
        case 4:
          message.orderFill = StreamOrderbookFill.decode(
            reader,
            reader.uint32(),
          );
          break;
        ...
        case 6:
          message.subaccountUpdate = StreamSubaccountUpdate.decode(
            reader,
            reader.uint32(),
          );
          break;
        ...
        case 7:
          message.priceUpdate = StreamPriceUpdate.decode(
            reader,
            reader.uint32(),
          );
          break;
...
export const StreamOrderbookUpdate = {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          message.updates.push(
            OffChainUpdateV1.decode(reader, reader.uint32()),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<StreamOrderbookUpdate>,
  ): StreamOrderbookUpdate {
    const message = createBaseStreamOrderbookUpdate();
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): StreamTakerOrder {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          message.liquidationOrder = StreamLiquidationOrder.decode(
            reader,
            reader.uint32(),
          );
          break;
        ...
        case 3:
          message.takerOrderStatus = StreamTakerOrderStatus.decode(
            reader,
            reader.uint32(),
          );
          break;
...
export const StreamTakerOrderStatus = {
  ...
  fromPartial(
    object: DeepPartial<StreamTakerOrderStatus>,
  ): StreamTakerOrderStatus {
    const message = createBaseStreamTakerOrderStatus();
