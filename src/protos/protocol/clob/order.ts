...
import {
  ...
  PerpetualLiquidationInfoSDKType,
...
export const OrdersFilledDuringLatestBlock = {
  ...
  fromPartial(
    object: DeepPartial<OrdersFilledDuringLatestBlock>,
  ): OrdersFilledDuringLatestBlock {
    const message = createBaseOrdersFilledDuringLatestBlock();
    message.orderIds =
...
export const PotentiallyPrunableOrders = {
  ...
  fromPartial(
    object: DeepPartial<PotentiallyPrunableOrders>,
  ): PotentiallyPrunableOrders {
    const message = createBasePotentiallyPrunableOrders();
    message.orderIds =
      object.orderIds?.map((e) => OrderId.fromPartial(e)) || [];
...
export const StatefulOrderTimeSliceValue = {
  ...
  fromPartial(
    object: DeepPartial<StatefulOrderTimeSliceValue>,
  ): StatefulOrderTimeSliceValue {
    const message = createBaseStatefulOrderTimeSliceValue();
    message.orderIds =
      object.orderIds?.map((e) => OrderId.fromPartial(e)) || [];
...
export const LongTermOrderPlacement = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          message.placementIndex = TransactionOrdering.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<LongTermOrderPlacement>,
  ): LongTermOrderPlacement {
    const message = createBaseLongTermOrderPlacement();
    message.order =
...
export const ConditionalOrderPlacement = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          message.triggerIndex = TransactionOrdering.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<ConditionalOrderPlacement>,
  ): ConditionalOrderPlacement {
    const message = createBaseConditionalOrderPlacement();
    message.order =
      object.order !== undefined && object.order !== null
...
export const StreamLiquidationOrder = {
  encode(
    ...
    if (message.liquidationInfo !== undefined) {
      PerpetualLiquidationInfo.encode(
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.liquidationInfo = PerpetualLiquidationInfo.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<StreamLiquidationOrder>,
  ): StreamLiquidationOrder {
    const message = createBaseStreamLiquidationOrder();
    message.liquidationInfo =
