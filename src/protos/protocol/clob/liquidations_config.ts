  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): LiquidationsConfig {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          message.positionBlockLimits = PositionBlockLimits.decode(
            reader,
            reader.uint32(),
          );
          break;
        ...
        case 3:
          message.subaccountBlockLimits = SubaccountBlockLimits.decode(
            reader,
            reader.uint32(),
          );
          break;
        ...
        case 4:
          message.fillablePriceConfig = FillablePriceConfig.decode(
            reader,
            reader.uint32(),
          );
          break;
...
export const SubaccountBlockLimits = {
  ...
  fromPartial(
    object: DeepPartial<SubaccountBlockLimits>,
  ): SubaccountBlockLimits {
    const message = createBaseSubaccountBlockLimits();
