...
export const BlockRateLimitConfiguration = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.maxShortTermOrdersPerNBlocks.push(
            MaxPerNBlocksRateLimit.decode(reader, reader.uint32()),
          );
          break;

        case 2:
          message.maxStatefulOrdersPerNBlocks.push(
            MaxPerNBlocksRateLimit.decode(reader, reader.uint32()),
          );
          break;

        case 3:
          message.maxShortTermOrderCancellationsPerNBlocks.push(
            MaxPerNBlocksRateLimit.decode(reader, reader.uint32()),
          );
          break;

        case 4:
          message.maxShortTermOrdersAndCancelsPerNBlocks.push(
            MaxPerNBlocksRateLimit.decode(reader, reader.uint32()),
          );
          break;
  ...
  fromPartial(
    object: DeepPartial<BlockRateLimitConfiguration>,
  ): BlockRateLimitConfiguration {
    const message = createBaseBlockRateLimitConfiguration();
    message.maxShortTermOrdersPerNBlocks =
      object.maxShortTermOrdersPerNBlocks?.map((e) =>
        MaxPerNBlocksRateLimit.fromPartial(e),
      ) || [];
    message.maxStatefulOrdersPerNBlocks =
      object.maxStatefulOrdersPerNBlocks?.map((e) =>
        MaxPerNBlocksRateLimit.fromPartial(e),
      ) || [];
    message.maxShortTermOrderCancellationsPerNBlocks =
      object.maxShortTermOrderCancellationsPerNBlocks?.map((e) =>
        MaxPerNBlocksRateLimit.fromPartial(e),
      ) || [];
    message.maxShortTermOrdersAndCancelsPerNBlocks =
      object.maxShortTermOrdersAndCancelsPerNBlocks?.map((e) =>
        MaxPerNBlocksRateLimit.fromPartial(e),
      ) || [];
    return message;
  },
...
export const MaxPerNBlocksRateLimit = {
  ...
  fromPartial(
    object: DeepPartial<MaxPerNBlocksRateLimit>,
  ): MaxPerNBlocksRateLimit {
    const message = createBaseMaxPerNBlocksRateLimit();
