...
export class MsgClientImpl implements Msg {
  ...
  addAuthenticator(
    ...
    return promise.then((data) =>
      MsgAddAuthenticatorResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  removeAuthenticator(
    ...
    return promise.then((data) =>
      MsgRemoveAuthenticatorResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  setActiveState(
    ...
    return promise.then((data) =>
      MsgSetActiveStateResponse.decode(new _m0.Reader(data)),
    );
  }
}
