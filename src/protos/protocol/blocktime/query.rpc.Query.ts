...
export interface Query {
  ...
  downtimeParams(
    request?: QueryDowntimeParamsRequest,
  ): Promise<QueryDowntimeParamsResponse>;
  /** Queries the information of the previous block */

  previousBlockInfo(
    request?: QueryPreviousBlockInfoRequest,
  ): Promise<QueryPreviousBlockInfoResponse>;
  /** Queries all recorded downtime info. */

  allDowntimeInfo(
    request?: QueryAllDowntimeInfoRequest,
  ): Promise<QueryAllDowntimeInfoResponse>;
}
export class QueryClientImpl implements Query {
  ...
  downtimeParams(
    ...
    const promise = this.rpc.request(
      'dydxprotocol.blocktime.Query',
      'DowntimeParams',
      data,
    );
    return promise.then((data) =>
      QueryDowntimeParamsResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  previousBlockInfo(
    ...
    return promise.then((data) =>
      QueryPreviousBlockInfoResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  allDowntimeInfo(
    ...
    return promise.then((data) =>
      QueryAllDowntimeInfoResponse.decode(new _m0.Reader(data)),
    );
  }
}
