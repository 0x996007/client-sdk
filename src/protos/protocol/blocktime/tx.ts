...
import {
  DowntimeParams,
  DowntimeParamsSDKType,
  SynchronyParams,
  SynchronyParamsSDKType,
} from './params.js';
...
export const MsgUpdateDowntimeParams = {
  ...
  fromPartial(
    object: DeepPartial<MsgUpdateDowntimeParams>,
  ): MsgUpdateDowntimeParams {
    const message = createBaseMsgUpdateDowntimeParams();
...
export const MsgUpdateDowntimeParamsResponse = {
  encode(
    _: MsgUpdateDowntimeParamsResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<MsgUpdateDowntimeParamsResponse>,
  ): MsgUpdateDowntimeParamsResponse {
    const message = createBaseMsgUpdateDowntimeParamsResponse();
    return message;
  },
...
export const MsgUpdateSynchronyParams = {
  ...
  fromPartial(
    object: DeepPartial<MsgUpdateSynchronyParams>,
  ): MsgUpdateSynchronyParams {
    const message = createBaseMsgUpdateSynchronyParams();
    message.authority = object.authority ?? '';
    message.params =
...
export const MsgUpdateSynchronyParamsResponse = {
  encode(
    _: MsgUpdateSynchronyParamsResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<MsgUpdateSynchronyParamsResponse>,
  ): MsgUpdateSynchronyParamsResponse {
    const message = createBaseMsgUpdateSynchronyParamsResponse();
    return message;
  },
