...
import {
  ...
  QueryDowntimeParamsResponseSDKType,
  QueryAllDowntimeInfoRequest,
  QueryAllDowntimeInfoResponseSDKType,
} from './query.js';
export class LCDQueryClient {
  ...
  async downtimeParams(
    _params: QueryDowntimeParamsRequest = {},
  ): Promise<QueryDowntimeParamsResponseSDKType> {
  ...
  async allDowntimeInfo(
    _params: QueryAllDowntimeInfoRequest = {},
  ): Promise<QueryAllDowntimeInfoResponseSDKType> {
