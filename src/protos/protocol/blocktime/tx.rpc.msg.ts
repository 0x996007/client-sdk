...
export interface Msg {
  ...
  updateDowntimeParams(
    request: MsgUpdateDowntimeParams,
  ): Promise<MsgUpdateDowntimeParamsResponse>;
  /** UpdateSynchronyParams updates the SynchronyParams in state. */

  updateSynchronyParams(
    request: MsgUpdateSynchronyParams,
  ): Promise<MsgUpdateSynchronyParamsResponse>;
}
export class MsgClientImpl implements Msg {
  ...
  updateDowntimeParams(
    ...
    return promise.then((data) =>
      MsgUpdateDowntimeParamsResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  updateSynchronyParams(
    ...
    return promise.then((data) =>
      MsgUpdateSynchronyParamsResponse.decode(new _m0.Reader(data)),
    );
  }
}
