...
export const QueryDowntimeParamsRequest = {
  ...
  fromPartial(
    _: DeepPartial<QueryDowntimeParamsRequest>,
  ): QueryDowntimeParamsRequest {
    const message = createBaseQueryDowntimeParamsRequest();
    return message;
  },
...
export const QueryDowntimeParamsResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryDowntimeParamsResponse>,
  ): QueryDowntimeParamsResponse {
    const message = createBaseQueryDowntimeParamsResponse();
    message.params =
...
export const QueryPreviousBlockInfoRequest = {
  encode(
    _: QueryPreviousBlockInfoRequest,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: DeepPartial<QueryPreviousBlockInfoRequest>,
  ): QueryPreviousBlockInfoRequest {
    const message = createBaseQueryPreviousBlockInfoRequest();
    return message;
  },
...
export const QueryPreviousBlockInfoResponse = {
  encode(
    message: QueryPreviousBlockInfoResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
  ...
  fromPartial(
    object: DeepPartial<QueryPreviousBlockInfoResponse>,
  ): QueryPreviousBlockInfoResponse {
    const message = createBaseQueryPreviousBlockInfoResponse();
    message.info =
...
export const QueryAllDowntimeInfoRequest = {
  ...
  fromPartial(
    _: DeepPartial<QueryAllDowntimeInfoRequest>,
  ): QueryAllDowntimeInfoRequest {
    const message = createBaseQueryAllDowntimeInfoRequest();
    return message;
  },
...
export const QueryAllDowntimeInfoResponse = {
  encode(
    message: QueryAllDowntimeInfoResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    if (message.info !== undefined) {
  ...
  fromPartial(
    object: DeepPartial<QueryAllDowntimeInfoResponse>,
  ): QueryAllDowntimeInfoResponse {
    const message = createBaseQueryAllDowntimeInfoResponse();
    message.info =
      object.info !== undefined && object.info !== null
