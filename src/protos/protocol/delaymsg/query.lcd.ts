...
import {
  ...
  QueryNextDelayedMessageIdResponseSDKType,
  QueryMessageRequest,
  QueryMessageResponseSDKType,
  QueryBlockMessageIdsRequest,
  QueryBlockMessageIdsResponseSDKType,
} from './query.js';
export class LCDQueryClient {
  ...
  async nextDelayedMessageId(
    _params: QueryNextDelayedMessageIdRequest = {},
  ): Promise<QueryNextDelayedMessageIdResponseSDKType> {
    const endpoint = `dydxprotocol/v4/delaymsg/next_id`;
    return await this.req.get<QueryNextDelayedMessageIdResponseSDKType>(
      endpoint,
    );
  }
  ...
  async message(
    params: QueryMessageRequest,
  ): Promise<QueryMessageResponseSDKType> {
  ...
  async blockMessageIds(
    params: QueryBlockMessageIdsRequest,
  ): Promise<QueryBlockMessageIdsResponseSDKType> {
