...
import { DelayedMessage, DelayedMessageSDKType } from './delayed_message.js';
...
export const QueryNextDelayedMessageIdRequest = {
  encode(
    _: QueryNextDelayedMessageIdRequest,
  ...
  fromPartial(
    _: DeepPartial<QueryNextDelayedMessageIdRequest>,
  ): QueryNextDelayedMessageIdRequest {
    const message = createBaseQueryNextDelayedMessageIdRequest();
    return message;
  },
...
export const QueryNextDelayedMessageIdResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryNextDelayedMessageIdResponse>,
  ): QueryNextDelayedMessageIdResponse {
    const message = createBaseQueryNextDelayedMessageIdResponse();
...
export const QueryBlockMessageIdsRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryBlockMessageIdsRequest>,
  ): QueryBlockMessageIdsRequest {
    const message = createBaseQueryBlockMessageIdsRequest();
...
export const QueryBlockMessageIdsResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryBlockMessageIdsResponse>,
  ): QueryBlockMessageIdsResponse {
    const message = createBaseQueryBlockMessageIdsResponse();
