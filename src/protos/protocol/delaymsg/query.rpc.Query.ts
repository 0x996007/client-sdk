...
export interface Query {
  ...
  nextDelayedMessageId(
    request?: QueryNextDelayedMessageIdRequest,
  ): Promise<QueryNextDelayedMessageIdResponse>;
  ...
  blockMessageIds(
    request: QueryBlockMessageIdsRequest,
  ): Promise<QueryBlockMessageIdsResponse>;
}
export class QueryClientImpl implements Query {
  ...
  nextDelayedMessageId(
    ...
    return promise.then((data) =>
      QueryNextDelayedMessageIdResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  message(request: QueryMessageRequest): Promise<QueryMessageResponse> {
    ...
    return promise.then((data) =>
      QueryMessageResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  blockMessageIds(
    ...
    return promise.then((data) =>
      QueryBlockMessageIdsResponse.decode(new _m0.Reader(data)),
    );
  }
}
