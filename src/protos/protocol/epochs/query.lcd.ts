...
import {
  ...
  QueryEpochInfoAllResponseSDKType,
} from './query.js';
export class LCDQueryClient {
  ...
  async epochInfo(
    params: QueryGetEpochInfoRequest,
  ): Promise<QueryEpochInfoResponseSDKType> {
  ...
  async epochInfoAll(
    params: QueryAllEpochInfoRequest = {
    ...
    return await this.req.get<QueryEpochInfoAllResponseSDKType>(
      endpoint,
      options,
    );
  }
