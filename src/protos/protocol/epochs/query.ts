...
export const QueryGetEpochInfoRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryGetEpochInfoRequest>,
  ): QueryGetEpochInfoRequest {
    const message = createBaseQueryGetEpochInfoRequest();
...
export const QueryEpochInfoResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryEpochInfoResponse>,
  ): QueryEpochInfoResponse {
    const message = createBaseQueryEpochInfoResponse();
    message.epochInfo =
...
export const QueryAllEpochInfoRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryAllEpochInfoRequest>,
  ): QueryAllEpochInfoRequest {
    const message = createBaseQueryAllEpochInfoRequest();
    message.pagination =
...
export const QueryEpochInfoAllResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryEpochInfoAllResponse>,
  ): QueryEpochInfoAllResponse {
    const message = createBaseQueryEpochInfoAllResponse();
    message.epochInfo =
