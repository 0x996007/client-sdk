...
import {
  ...
  QueryPerpetualFeeParamsResponseSDKType,
  QueryUserFeeTierRequest,
  QueryUserFeeTierResponseSDKType,
} from './query.js';
export class LCDQueryClient {
  ...
  async perpetualFeeParams(
    _params: QueryPerpetualFeeParamsRequest = {},
  ): Promise<QueryPerpetualFeeParamsResponseSDKType> {
  ...
  async userFeeTier(
    params: QueryUserFeeTierRequest,
  ): Promise<QueryUserFeeTierResponseSDKType> {
    const options: any = {
      params: {},
    };
    ...
    return await this.req.get<QueryUserFeeTierResponseSDKType>(
      endpoint,
      options,
    );
  }
