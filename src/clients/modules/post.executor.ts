...
export class PostExecutor {
  ...
  async withdrawDelegatorReward(
    ...
    const msg = this.composer.composeMsgWithdrawDelegatorReward(
      delegator,
      validator,
    );
    return this.send(
  ...
  withdrawDelegatorRewardMsg(
    ...
    return this.composer.composeMsgWithdrawDelegatorReward(
      delegator,
      validator,
    );
  }
  ...
  depositToMegavaultMsg(
    ...args: Parameters<MsgBuilder['composeMsgDepositToMegavault']>
  ): EncodeObject {
  ...
  withdrawFromMegavaultMsg(
    ...args: Parameters<MsgBuilder['composeMsgWithdrawFromMegavault']>
  ): EncodeObject {
  ...
  registerAffiliateMsg(
    ...args: Parameters<MsgBuilder['composeMsgRegisterAffiliate']>
  ): EncodeObject {
    return this.composer.composeMsgRegisterAffiliate(...args);
  }

  launchMarketMsg(
    ...args: Parameters<MsgBuilder['composeMsgCreateMarketPermissionless']>
  ): EncodeObject {
  ...
  async createMarketPermissionless(
    ...
    const msg = this.launchMarketMsg(
      subaccount.address,
      ticker,
      subaccount.subaccountNumber,
    );
